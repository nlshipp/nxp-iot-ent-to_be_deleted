/*
* Description: iMX8M Plus SPI Controllers
*
...
Device (SPI1)
{
  ...
  Name (_CRS, ResourceTemplate () {
    ...
    // SS0 (PAD_ECSPI1_SS0)   - UART3_RTS_B   - GPIO5_IO09 (137) - EXP CN (J21) pin 11
    GpioIO (Shared, PullDown, 0, 0, IoRestrictionNone, "\\_SB.GPIO", 0, ResourceConsumer, , ) { 137 }

    // MISO (PAD_ECSPI1_MISO) - UART3_CTS_B   - GPIO5_IO08 (136) - EXP CN (J21) pin 7
    // MOSI (PAD_ECSPI1_MOSI) - UART3_TX_DATA - GPIO5_IO07 (135) - EXP CN (J21) pin 8
    // SCLK (PAD_ECSPI1_SCLK) - UART3_RX_DATA - GPIO5_IO06 (134) - EXP CN (J21) pin 10
...
Device (SPI2)
{
  ...
  Name (_CRS, ResourceTemplate () {
    ...
    // SS0 (PAD_ECSPI2_SS0) - GPIO5_IO13 (141) - EXP CN (J21) 24
    GpioIO (Shared, PullDown, 0, 0, IoRestrictionNone, "\\_SB.GPIO", 0, ResourceConsumer, , ) { 141 }

    // MISO (PAD_ECSPI2_MISO) - GPIO5_IO12 (140) - EXP CN (J21) 21
    // MOSI (PAD_ECSPI2_MOSI) - GPIO5_IO11 (139) - EXP CN (J21) 19
    // SCLK (PAD_ECSPI2_SCLK) - GPIO5_IO10 (138) - EXP CN (J21) 23
    // MsftFunctionConfig (Exclusive, PullDown, IMX_ALT0, "\\_SB.GPIO", 0,
