...
class ImxPlatformBuilder(UpdateSettingsManager, SetupSettingsManager, BuildSettingsManager, UefiBuilder):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("ACTIVE_PLATFORM", "NXP/EVK_iMX8MP_6GB/EVK_iMX8MP_6GB.dsc", "Platform Hardcoded")
        self.env.SetValue("PRODUCT_NAME", "EVK_iMX8MP_6GB", "Platform Hardcoded")
    ...
    def SetPlatformEnvAfterTarget(self):
        ...
        self.env.SetValue("BUILD_OUTPUT_BASE", value, "Computed in EVK_iMX8MP_6GB Build")

        # Output FD file
        key = "OUTPUT_FD"
        value = os.path.join(self.env.GetValue("BUILD_OUTPUT_BASE"), "FV", "ClientBios.fd")
        self.env.SetValue(key, value, "Computed in EVK_iMX8MP_6GB Build")
