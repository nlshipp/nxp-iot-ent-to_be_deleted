...
#define SD_HIGH_SPEED_MODE_CLOCK_FREQ_HZ    50000000  // 50 MHz
...
typedef struct {
  ...
  UINT8 ExtendedCsdRevision;              // 192
  UINT8 Reserved12;
  UINT8 CsdStructureVersion;              // 194
  UINT8 Reserved11;
  UINT8 CardType;                         // 196
  UINT8 Reserved10[3];
  ...
  UINT16 Reserved3;
  UINT8 PowerClass52MhzDdr36V;                 // 238
  UINT8 PowerClass52MhzDdr195V;                // 239
  UINT8 Reserved2;
  UINT8 InitTimeoutAfterPartitioning;          // 241
  UINT8 Reserved1[262];
  UINT8 SupportedCmdSets;                      // 504
  UINT8 Reserved[7];
} MMC_EXT_CSD;
