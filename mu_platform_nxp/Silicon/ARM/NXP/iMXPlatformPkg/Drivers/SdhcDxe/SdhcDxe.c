/** @file
  gSdhcCounters->channel[SdhcCtx->SdhcId - 1] = TargetFreqHz;
*
...
typedef struct
{
    ...
    UINT64 Width;
    UINT64 Freq;
} SDHC_CHANNEL_COUNTERS;

typedef struct
{
    SDHC_CHANNEL_COUNTERS channel[4];
    UINT64 StartTime;
    UINT64 LastTime;
    UINT64 CounterFreq;
} SDHC_COUNTERS;

SDHC_COUNTERS* gSdhcCounters = NULL;
  ...
  )
{
  ...
  if (IntStatus.AsUint32 & USDHC_INT_STATUS_ERROR) {
    LOG_ERROR ("WaitForReadFifo: Error detected");
    DumpState (SdhcCtx);
  ...
  )
{
  ...
  if (IntStatus.AsUint32 & USDHC_INT_STATUS_ERROR) {
    LOG_ERROR ("WaitForWriteFifo: Error detected");
    DumpState (SdhcCtx);
    return EFI_DEVICE_ERROR;
  ...
  )
{
  ...
  if (IntStatus.AsUint32 & USDHC_INT_STATUS_ERROR) {
    LOG_ERROR ("WaitForCmdAndOrDataLine: Error detected");
    DumpState (SdhcCtx);
    return EFI_DEVICE_ERROR;
  ...
  )
{
  ...
  if (IntStatus.AsUint32 & USDHC_INT_STATUS_ERROR) {
    LOG_ERROR ("WaitForCmdResponse: Error detected");
    DumpState (SdhcCtx);
    return EFI_DEVICE_ERROR;
  ...
  )
{
  ...
  gSdhcCounters->channel[SdhcCtx->SdhcId - 1].Width = BusWidth;
  ...
  )
{
  ...
  if (This->DevFlagDdr) {
    MixCtrl.Fields.DDR_EN = 1;
    LOG_TRACE ("SdhcSetClock - DDR enabled");
  } else {
    MixCtrl.Fields.DDR_EN = 0;
  }
  ...
  gSdhcCounters->channel[SdhcCtx->SdhcId - 1].Freq = TargetFreqHz;
  ...
  )
{
  ...
  if (XfrInfo) {
    ...
    MixCtrl.AsUint32 = MmioRead32 ((UINTN)&Reg->MIX_CTRL) & 8;
  ...
  )
{
  ...
  StartClk = GetPerformanceCounter();
  ...
  gSdhcCounters->LastTime = GetPerformanceCounter();

  gSdhcCounters->channel[SdhcCtx->SdhcId - 1].ReadBytes += LengthInBytes;
  gSdhcCounters->channel[SdhcCtx->SdhcId - 1].ReadCount ++;
  gSdhcCounters->channel[SdhcCtx->SdhcId - 1].ReadTime += gSdhcCounters->LastTime - StartClk;
  ...
  )
{
  ...
  gSdhcCounters->channel[SdhcCtx->SdhcId - 1].WriteBytes += LengthInBytes;
  gSdhcCounters->channel[SdhcCtx->SdhcId - 1].WriteCount ++;
  gSdhcCounters->channel[SdhcCtx->SdhcId - 1].WriteTime += gSdhcCounters->LastTime - StartClk;
  ...
  )
{
  ...
  gSdhcCounters->channel[SdhcCtx->SdhcId - 1].ResetCount ++;
...
SdhcDeviceRegister (
  ...
  IN USDHC_DEVICE_TYPE DeviceType
  )
{
  USDHC_PRIVATE_CONTEXT   *SdhcCtx;
  ...
  SdhcProtocol->DeviceType = DeviceType;
  ...
  )
{
  ...
  // ****  temporary sdhc perf counters
  gSdhcCounters = (SDHC_COUNTERS *)FixedPcdGet32 (PcdGlobalDataBaseAddress);
  
  ZeroMem(gSdhcCounters, sizeof(SDHC_COUNTERS));
  gSdhcCounters->CounterFreq = GetPerformanceCounterProperties(NULL, NULL);
  gSdhcCounters->StartTime = GetPerformanceCounter();
  // ****  temporary sdhc perf counters
  ...
  if (FixedPcdGet32 (PcdSdhc1Enable)) {
    Status = SdhcDeviceRegister (
               ...
               FixedPcdGet32 (PcdSdhc1DeviceType));
    if (!EFI_ERROR (Status)) {
      ++SdhcRegisteredCount;
    }
  }
  ...
  if (FixedPcdGet32 (PcdSdhc2Enable)) {
    Status = SdhcDeviceRegister (
               ...
               FixedPcdGet32 (PcdSdhc2DeviceType));
    if (!EFI_ERROR (Status)) {
      ++SdhcRegisteredCount;
    }
  }
  ...
  if (FixedPcdGet32 (PcdSdhc3Enable)) {
    Status = SdhcDeviceRegister (
               ...
               FixedPcdGet32 (PcdSdhc3DeviceType));
    if (!EFI_ERROR (Status)) {
      ++SdhcRegisteredCount;
    }
  }
  ...
  if (FixedPcdGet32 (PcdSdhc4Enable)) {
    Status = SdhcDeviceRegister (
               ...
               FixedPcdGet32 (PcdSdhc4DeviceType));
    if (!EFI_ERROR (Status)) {
      ++SdhcRegisteredCount;
    }
  }
