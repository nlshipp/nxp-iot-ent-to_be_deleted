...
#define DISPLAY_MIX_CLK_EN_MIPI_DSI_ACLK_SFT_EN_SHIFT       (10)
#define DISPLAY_MIX_CLK_EN_MIPI_DSI_ACLK_SFT_EN_MASK        (1UL << DISPLAY_MIX_CLK_EN_MIPI_DSI_ACLK_SFT_EN_SHIFT)
