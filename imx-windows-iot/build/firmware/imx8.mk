...
IMX8_MKIMAGE_DEPS_LPDDR4=$(wildcard $(IMX8_REPO_ROOT)/firmware-imx/firmware/ddr/synopsys/lpddr4_pmu_train_*.bin)
IMX8_MKIMAGE_DEPS_DDR4=$(wildcard $(IMX8_REPO_ROOT)/firmware-imx/firmware/ddr/synopsys/ddr4_*.bin)
IMX8_MKIMAGE_DEPS_HDMI=$(wildcard $(IMX8_REPO_ROOT)/firmware-imx/firmware/hdmi/cadence/signed_hdmi_imx8m.bin)
IMX8_MKIMAGE_DEPS_OPTEE=$(IMX8_REPO_ROOT)/imx-optee-os/out/arm-plat-imx/tee.bin
IMX8_MKIMAGE_DEPS_ATF=$(IMX8_REPO_ROOT)/imx-atf/build/$(ATF_CONFIG)/release/bl31.bin
IMX8_MKIMAGE_DEPS_U-BOOT=$(IMX8_REPO_ROOT)/uboot-imx/u-boot-nodtb.bin $(IMX8_REPO_ROOT)/uboot-imx/spl/u-boot-spl.bin $(IMX8_REPO_ROOT)/uboot-imx/arch/arm/dts/$(U_BOOT_DTS).dtb $(IMX8_REPO_ROOT)/uboot-imx/tools/mkimage
...
imx8_uefi: imx8_u-boot imx8_tas its/uefi_imx8_unsigned.its
	...
	$(IMX8_REPO_ROOT)/uboot-imx/tools/mkimage -f uefi_imx8_unsigned.its -r uefi.fit
	$(call sign_uefi_binary,uefi.fit)

imx8_build: imx8_uefi imx8_mkimage

imx8_update-binaries: imx8_build
	cp $(IMX8_REPO_ROOT)/imx-mkimage/iMX8M/flash.bin $(CURDIR)/../../BSP/$(IMX8_TARGET)/boot_firmware/flash.bin
	cp $(IMX8_REPO_ROOT)/mu_platform_nxp/Build/$(EDK2_PLATFORM)/RELEASE_GCC5/FV/uefi.fit $(CURDIR)/../../BSP/$(IMX8_TARGET)/boot_firmware/uefi.fit

imx8_commit-firmware: imx8_update-ffu
	git add $(CURDIR)/../../BSP/$(IMX8_TARGET)/boot_firmware
