...
{
	/* Control0[Bit0] setting:
	* 0: if dcss pixel clock is generated by VIDEO PLL2
	* 1: if dcss pixel clock is generated by HDMI PHY
	*/
	if (blkctl->dcss->hdmi_output)
		dcss_writel(HDMI_MIPI_CLK_SEL,
