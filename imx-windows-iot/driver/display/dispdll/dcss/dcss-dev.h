...
void dcss_ctxld_register_dtrc_cb(struct dcss_ctxld *ctxld,
	bool(*cb)(void *),
	void *data);
bool dcss_ctxld_is_armed(struct dcss_ctxld *ctxld);
...
void dcss_dpr_addr_set_no_ctxld(struct dcss_dpr *dpr, int ch_num,
	u32 base_addr);
void dcss_dpr_tile_set_no_ctxld(struct dcss_dpr *dpr, int ch_num,
	uint64_t modifier);
...
void dcss_scaler_exit(struct dcss_scaler *scl, bool stop);
