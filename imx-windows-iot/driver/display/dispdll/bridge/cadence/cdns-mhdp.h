...
typedef u32 mhdp_op(struct cdns_mhdp_device *mhdp, u32 offset);

inline int mhdp_readx_poll_timeout(mhdp_op *op,
	struct cdns_mhdp_device *addr, u32 offset,
	bool cond, unsigned long sleep_us,
	u64 timeout_us)
{
	int _val;
	...
	return (cond ? _val : !_val) ? 0 : -ETIMEDOUT;
}
