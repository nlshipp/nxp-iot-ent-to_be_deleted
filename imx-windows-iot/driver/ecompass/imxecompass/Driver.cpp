...
// Abstract:
//
//  This module contains the implementation of entry and exit point of eCompass driver.
//
// Environment:
//
    ...
    )
{
    ...
    DriverConfig.DriverPoolTag = SENSORV2_POOL_TAG_ECOMPASS;
    ...
    {
        TraceError("eCompass %!FUNC! WdfDriverCreate failed: %!STATUS!", Status);
        goto Exit;
    }
