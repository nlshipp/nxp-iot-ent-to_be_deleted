...
namespace {
  ...
  const IMX_PIN_DATA Imx6ULLGpioPinDataSparseMap[] = {
    ...
    //--------------------------------------------------
    { IMX_MAKE_PIN_1(1,  0), 0x2E8, 0x000010B0,  0x5C, 0x05, 0x05 }, // GPIO1_IO00 GPIO1_IO00
    { IMX_MAKE_PIN_1(1,  1), 0x2EC, 0x000010B0,  0x60, 0x05, 0x05 }, // GPIO1_IO01 GPIO1_IO01
    { IMX_MAKE_PIN_1(1,  2), 0x2F0, 0x000010B0,  0x64, 0x05, 0x05 }, // GPIO1_IO02 GPIO1_IO02
    { IMX_MAKE_PIN_1(1,  3), 0x2F4, 0x000010B0,  0x68, 0x05, 0x05 }, // GPIO1_IO03 GPIO1_IO03
    { IMX_MAKE_PIN_1(1,  4), 0x2F8, 0x000010B0,  0x6C, 0x05, 0x05 }, // GPIO1_IO04 GPIO1_IO04
    { IMX_MAKE_PIN_1(1,  5), 0x2FC, 0x000010B0,  0x70, 0x05, 0x05 }, // GPIO1_IO05 GPIO1_IO05
    { IMX_MAKE_PIN_1(1,  6), 0x300, 0x000010B0,  0x74, 0x05, 0x05 }, // GPIO1_IO06 GPIO1_IO06
    { IMX_MAKE_PIN_1(1,  7), 0x304, 0x000010B0,  0x78, 0x05, 0x05 }, // GPIO1_IO07 GPIO1_IO07
    { IMX_MAKE_PIN_1(1,  8), 0x308, 0x000010B0,  0x7C, 0x05, 0x05 }, // GPIO1_IO08 GPIO1_IO08
    { IMX_MAKE_PIN_1(1,  9), 0x30C, 0x000010B0,  0x80, 0x05, 0x05 }, // GPIO1_IO09 GPIO1_IO09
    { IMX_MAKE_PIN_1(1, 10), 0x2D0, 0x0000B0A0,  0x44, 0x00, 0x05 }, // GPIO1_IO10 JTAG_MOD
    { IMX_MAKE_PIN_1(1, 11), 0x2D4, 0x000070A0,  0x48, 0x00, 0x05 }, // GPIO1_IO11 JTAG_TMS
    { IMX_MAKE_PIN_1(1, 12), 0x2D8, 0x000090B1,  0x4C, 0x00, 0x05 }, // GPIO1_IO12 JTAG_TDO
    { IMX_MAKE_PIN_1(1, 13), 0x2DC, 0x000070A0,  0x50, 0x00, 0x05 }, // GPIO1_IO13 JTAG_TDI
    { IMX_MAKE_PIN_1(1, 14), 0x2E0, 0x000070A0,  0x54, 0x00, 0x05 }, // GPIO1_IO14 JTAG_TCK
    { IMX_MAKE_PIN_1(1, 15), 0x2E4, 0x000070A0,  0x58, 0x00, 0x05 }, // GPIO1_IO15 JTAG_TRST_B
    { IMX_MAKE_PIN_1(1, 16), 0x310, 0x000010B0,  0x84, 0x05, 0x05 }, // GPIO1_IO16 UART1_TX_DATA
    { IMX_MAKE_PIN_1(1, 17), 0x314, 0x000010B0,  0x88, 0x05, 0x05 }, // GPIO1_IO17 UART1_RX_DATA
    { IMX_MAKE_PIN_1(1, 18), 0x318, 0x000010B0,  0x8C, 0x05, 0x05 }, // GPIO1_IO18 UART1_CTS_B
    { IMX_MAKE_PIN_1(1, 19), 0x31C, 0x000010B0,  0x90, 0x05, 0x05 }, // GPIO1_IO19 UART1_RTS_B
    { IMX_MAKE_PIN_1(1, 20), 0x320, 0x000010B0,  0x94, 0x05, 0x05 }, // GPIO1_IO20 UART2_TX_DATA
    { IMX_MAKE_PIN_1(1, 21), 0x324, 0x000010B0,  0x98, 0x05, 0x05 }, // GPIO1_IO21 UART2_RX_DATA
    { IMX_MAKE_PIN_1(1, 22), 0x328, 0x000010B0,  0x9C, 0x05, 0x05 }, // GPIO1_IO22 UART2_CTS_B
    { IMX_MAKE_PIN_1(1, 23), 0x32C, 0x000010B0,  0xA0, 0x05, 0x05 }, // GPIO1_IO23 UART2_RTS_B
    { IMX_MAKE_PIN_1(1, 24), 0x330, 0x000010B0,  0xA4, 0x05, 0x05 }, // GPIO1_IO24 UART3_TX_DATA
    { IMX_MAKE_PIN_1(1, 25), 0x334, 0x000010B0,  0xA8, 0x05, 0x05 }, // GPIO1_IO25 UART3_RX_DATA
    { IMX_MAKE_PIN_1(1, 26), 0x338, 0x000010B0,  0xAC, 0x05, 0x05 }, // GPIO1_IO26 UART3_CTS_B
    { IMX_MAKE_PIN_1(1, 27), 0x33C, 0x000010B0,  0xB0, 0x05, 0x05 }, // GPIO1_IO27 UART3_RTS_B
    { IMX_MAKE_PIN_1(1, 28), 0x340, 0x000010B0,  0xB4, 0x05, 0x05 }, // GPIO1_IO28 UART4_TX_DATA
    { IMX_MAKE_PIN_1(1, 29), 0x344, 0x000010B0,  0xB8, 0x05, 0x05 }, // GPIO1_IO29 UART4_RX_DATA
    { IMX_MAKE_PIN_1(1, 30), 0x348, 0x000010B0,  0xBC, 0x05, 0x05 }, // GPIO1_IO30 UART5_TX_DATA
    { IMX_MAKE_PIN_1(1, 31), 0x34C, 0x000010B0,  0xC0, 0x05, 0x05 }, // GPIO1_IO31 UART5_RX_DATA
    { IMX_MAKE_PIN_1(2,  0), 0x350, 0x000010B0,  0xC4, 0x05, 0x05 }, // GPIO2_IO00 ENET1_RX_DATA0
    { IMX_MAKE_PIN_1(2,  1), 0x354, 0x000010B0,  0xC8, 0x05, 0x05 }, // GPIO2_IO01 ENET1_RX_DATA1
    { IMX_MAKE_PIN_1(2,  2), 0x358, 0x000010B0,  0xCC, 0x05, 0x05 }, // GPIO2_IO02 ENET1_RX_EN
    { IMX_MAKE_PIN_1(2,  3), 0x35C, 0x000010B0,  0xD0, 0x05, 0x05 }, // GPIO2_IO03 ENET1_TX_DATA0
    { IMX_MAKE_PIN_1(2,  4), 0x360, 0x000010B0,  0xD4, 0x05, 0x05 }, // GPIO2_IO04 ENET1_TX_DATA1
    { IMX_MAKE_PIN_1(2,  5), 0x364, 0x000010B0,  0xD8, 0x05, 0x05 }, // GPIO2_IO05 ENET1_TX_EN
    { IMX_MAKE_PIN_1(2,  6), 0x368, 0x000010B0,  0xDC, 0x05, 0x05 }, // GPIO2_IO06 ENET1_TX_CLK
    { IMX_MAKE_PIN_1(2,  7), 0x36C, 0x000010B0,  0xE0, 0x05, 0x05 }, // GPIO2_IO07 ENET1_RX_ER
    { IMX_MAKE_PIN_1(2,  8), 0x370, 0x000010B0,  0xE4, 0x05, 0x05 }, // GPIO2_IO08 ENET2_RX_DATA0
    { IMX_MAKE_PIN_1(2,  9), 0x374, 0x000010B0,  0xE8, 0x05, 0x05 }, // GPIO2_IO09 ENET2_RX_DATA1
    { IMX_MAKE_PIN_1(2, 10), 0x378, 0x000010B0,  0xEC, 0x05, 0x05 }, // GPIO2_IO10 ENET2_RX_EN
    { IMX_MAKE_PIN_1(2, 11), 0x37C, 0x000010B0,  0xF0, 0x05, 0x05 }, // GPIO2_IO11 ENET2_TX_DATA0
    { IMX_MAKE_PIN_1(2, 12), 0x380, 0x000010B0,  0xF4, 0x05, 0x05 }, // GPIO2_IO12 ENET2_TX_DATA1
    { IMX_MAKE_PIN_1(2, 13), 0x384, 0x000010B0,  0xF8, 0x05, 0x05 }, // GPIO2_IO13 ENET2_TX_EN
    { IMX_MAKE_PIN_1(2, 14), 0x388, 0x000010B0,  0xFC, 0x05, 0x05 }, // GPIO2_IO14 ENET2_TX_CLK
    { IMX_MAKE_PIN_1(2, 15), 0x38C, 0x000010B0, 0x100, 0x05, 0x05 }, // GPIO2_IO15 ENET2_RX_ER
    { IMX_MAKE_PIN_1(2, 16), 0x448, 0x000010B0, 0x1BC, 0x05, 0x05 }, // GPIO2_IO16 SD1_CMD
    { IMX_MAKE_PIN_1(2, 17), 0x44C, 0x000010B0, 0x1C0, 0x05, 0x05 }, // GPIO2_IO17 SD1_CLK
    { IMX_MAKE_PIN_1(2, 18), 0x450, 0x000010B0, 0x1C4, 0x05, 0x05 }, // GPIO2_IO18 SD1_DATA0
    { IMX_MAKE_PIN_1(2, 19), 0x454, 0x000010B0, 0x1C8, 0x05, 0x05 }, // GPIO2_IO19 SD1_DATA1
    { IMX_MAKE_PIN_1(2, 20), 0x458, 0x000010B0, 0x1CC, 0x05, 0x05 }, // GPIO2_IO20 SD1_DATA2
    { IMX_MAKE_PIN_1(2, 21), 0x45C, 0x000010B0, 0x1D0, 0x05, 0x05 }, // GPIO2_IO21 SD1_DATA3
    { IMX_MAKE_PIN_1(3,  0), 0x390, 0x000010B0, 0x104, 0x05, 0x05 }, // GPIO3_IO00 LCD_CLK
    { IMX_MAKE_PIN_1(3,  1), 0x394, 0x000010B0, 0x108, 0x05, 0x05 }, // GPIO3_IO01 LCD_ENABLE
    { IMX_MAKE_PIN_1(3,  2), 0x398, 0x000010B0, 0x10C, 0x05, 0x05 }, // GPIO3_IO02 LCD_HSYNC
    { IMX_MAKE_PIN_1(3,  3), 0x39C, 0x000010B0, 0x110, 0x05, 0x05 }, // GPIO3_IO03 LCD_VSYNC
    { IMX_MAKE_PIN_1(3,  4), 0x3A0, 0x000010B0, 0x114, 0x05, 0x05 }, // GPIO3_IO04 LCD_RESET
    { IMX_MAKE_PIN_1(3,  5), 0x3A4, 0x000010B0, 0x118, 0x05, 0x05 }, // GPIO3_IO05 LCD_DATA00
    { IMX_MAKE_PIN_1(3,  6), 0x3A8, 0x000010B0, 0x11C, 0x05, 0x05 }, // GPIO3_IO06 LCD_DATA01
    { IMX_MAKE_PIN_1(3,  7), 0x3AC, 0x000010B0, 0x120, 0x05, 0x05 }, // GPIO3_IO07 LCD_DATA02
    { IMX_MAKE_PIN_1(3,  8), 0x3B0, 0x000010B0, 0x124, 0x05, 0x05 }, // GPIO3_IO08 LCD_DATA03
    { IMX_MAKE_PIN_1(3,  9), 0x3B4, 0x000010B0, 0x128, 0x05, 0x05 }, // GPIO3_IO09 LCD_DATA04
    { IMX_MAKE_PIN_1(3, 10), 0x3B8, 0x000010B0, 0x12C, 0x05, 0x05 }, // GPIO3_IO10 LCD_DATA05
    { IMX_MAKE_PIN_1(3, 11), 0x3BC, 0x000010B0, 0x130, 0x05, 0x05 }, // GPIO3_IO11 LCD_DATA06
    { IMX_MAKE_PIN_1(3, 12), 0x3C0, 0x000010B0, 0x134, 0x05, 0x05 }, // GPIO3_IO12 LCD_DATA07
    { IMX_MAKE_PIN_1(3, 13), 0x3C4, 0x000010B0, 0x138, 0x05, 0x05 }, // GPIO3_IO13 LCD_DATA08
    { IMX_MAKE_PIN_1(3, 14), 0x3C8, 0x000010B0, 0x13C, 0x05, 0x05 }, // GPIO3_IO14 LCD_DATA09
    { IMX_MAKE_PIN_1(3, 15), 0x3CC, 0x000010B0, 0x140, 0x05, 0x05 }, // GPIO3_IO15 LCD_DATA10
    { IMX_MAKE_PIN_1(3, 16), 0x3D0, 0x000010B0, 0x144, 0x05, 0x05 }, // GPIO3_IO16 LCD_DATA11
    { IMX_MAKE_PIN_1(3, 17), 0x3D4, 0x000010B0, 0x148, 0x05, 0x05 }, // GPIO3_IO17 LCD_DATA12
    { IMX_MAKE_PIN_1(3, 18), 0x3D8, 0x000010B0, 0x14C, 0x05, 0x05 }, // GPIO3_IO18 LCD_DATA13
    { IMX_MAKE_PIN_1(3, 19), 0x3DC, 0x000010B0, 0x150, 0x05, 0x05 }, // GPIO3_IO19 LCD_DATA14
    { IMX_MAKE_PIN_1(3, 20), 0x3E0, 0x000010B0, 0x154, 0x05, 0x05 }, // GPIO3_IO20 LCD_DATA15
    { IMX_MAKE_PIN_1(3, 21), 0x3E4, 0x000010B0, 0x158, 0x05, 0x05 }, // GPIO3_IO21 LCD_DATA16
    { IMX_MAKE_PIN_1(3, 22), 0x3E8, 0x000010B0, 0x15C, 0x05, 0x05 }, // GPIO3_IO22 LCD_DATA17
    { IMX_MAKE_PIN_1(3, 23), 0x3EC, 0x000010B0, 0x160, 0x05, 0x05 }, // GPIO3_IO23 LCD_DATA18
    { IMX_MAKE_PIN_1(3, 24), 0x3F0, 0x000010B0, 0x164, 0x05, 0x05 }, // GPIO3_IO24 LCD_DATA19
    { IMX_MAKE_PIN_1(3, 25), 0x3F4, 0x000010B0, 0x168, 0x05, 0x05 }, // GPIO3_IO25 LCD_DATA20
    { IMX_MAKE_PIN_1(3, 26), 0x3F8, 0x000010B0, 0x16C, 0x05, 0x05 }, // GPIO3_IO26 LCD_DATA21
    { IMX_MAKE_PIN_1(3, 27), 0x3FC, 0x000010B0, 0x170, 0x05, 0x05 }, // GPIO3_IO27 LCD_DATA22
    { IMX_MAKE_PIN_1(3, 28), 0x400, 0x000010B0, 0x174, 0x05, 0x05 }, // GPIO3_IO28 LCD_DATA23
    { IMX_MAKE_PIN_1(4,  0), 0x404, 0x000010B0, 0x178, 0x05, 0x05 }, // GPIO4_IO00 NAND_RE_B
    { IMX_MAKE_PIN_1(4,  1), 0x408, 0x000010B0, 0x17C, 0x05, 0x05 }, // GPIO4_IO01 NAND_WE_B
    { IMX_MAKE_PIN_1(4,  2), 0x40C, 0x000010B0, 0x180, 0x05, 0x05 }, // GPIO4_IO02 NAND_DATA00
    { IMX_MAKE_PIN_1(4,  3), 0x410, 0x000010B0, 0x184, 0x05, 0x05 }, // GPIO4_IO03 NAND_DATA01
    { IMX_MAKE_PIN_1(4,  4), 0x414, 0x000010B0, 0x188, 0x05, 0x05 }, // GPIO4_IO04 NAND_DATA02
    { IMX_MAKE_PIN_1(4,  5), 0x418, 0x000010B0, 0x18C, 0x05, 0x05 }, // GPIO4_IO05 NAND_DATA03
    { IMX_MAKE_PIN_1(4,  6), 0x41C, 0x000010B0, 0x190, 0x05, 0x05 }, // GPIO4_IO06 NAND_DATA04
    { IMX_MAKE_PIN_1(4,  7), 0x420, 0x000010B0, 0x194, 0x05, 0x05 }, // GPIO4_IO07 NAND_DATA05
    { IMX_MAKE_PIN_1(4,  8), 0x424, 0x000010B0, 0x198, 0x05, 0x05 }, // GPIO4_IO08 NAND_DATA06
    { IMX_MAKE_PIN_1(4,  9), 0x428, 0x000010B0, 0x19C, 0x05, 0x05 }, // GPIO4_IO09 NAND_DATA07
    { IMX_MAKE_PIN_1(4, 10), 0x42C, 0x000010B0, 0x1A0, 0x05, 0x05 }, // GPIO4_IO10 NAND_ALE
    { IMX_MAKE_PIN_1(4, 11), 0x430, 0x000010B0, 0x1A4, 0x05, 0x05 }, // GPIO4_IO11 NAND_WP_B
    { IMX_MAKE_PIN_1(4, 12), 0x434, 0x000010B0, 0x1A8, 0x05, 0x05 }, // GPIO4_IO12 NAND_READY_B
    { IMX_MAKE_PIN_1(4, 13), 0x438, 0x000010B0, 0x1AC, 0x05, 0x05 }, // GPIO4_IO13 NAND_CE0_B
    { IMX_MAKE_PIN_1(4, 14), 0x43C, 0x000010B0, 0x1B0, 0x05, 0x05 }, // GPIO4_IO14 NAND_CE1_B
    { IMX_MAKE_PIN_1(4, 15), 0x440, 0x000010B0, 0x1B4, 0x05, 0x05 }, // GPIO4_IO15 NAND_CLE
    { IMX_MAKE_PIN_1(4, 16), 0x444, 0x000010B0, 0x1B8, 0x05, 0x05 }, // GPIO4_IO16 NAND_DQS
    { IMX_MAKE_PIN_1(4, 17), 0x460, 0x000010B0, 0x1D4, 0x05, 0x05 }, // GPIO4_IO17 CSI_MCLK
    { IMX_MAKE_PIN_1(4, 18), 0x464, 0x000010B0, 0x1D8, 0x05, 0x05 }, // GPIO4_IO18 CSI_PIXCLK
    { IMX_MAKE_PIN_1(4, 19), 0x468, 0x000010B0, 0x1DC, 0x05, 0x05 }, // GPIO4_IO19 CSI_VSYNC
    { IMX_MAKE_PIN_1(4, 20), 0x46C, 0x000010B0, 0x1E0, 0x05, 0x05 }, // GPIO4_IO20 CSI_HSYNC
    { IMX_MAKE_PIN_1(4, 21), 0x470, 0x000010B0, 0x1E4, 0x05, 0x05 }, // GPIO4_IO21 CSI_DATA00
    { IMX_MAKE_PIN_1(4, 22), 0x474, 0x000010B0, 0x1E8, 0x05, 0x05 }, // GPIO4_IO22 CSI_DATA01
    { IMX_MAKE_PIN_1(4, 23), 0x478, 0x000010B0, 0x1EC, 0x05, 0x05 }, // GPIO4_IO23 CSI_DATA02
    { IMX_MAKE_PIN_1(4, 24), 0x47C, 0x000010B0, 0x1F0, 0x05, 0x05 }, // GPIO4_IO24 CSI_DATA03
    { IMX_MAKE_PIN_1(4, 25), 0x480, 0x000010B0, 0x1F4, 0x05, 0x05 }, // GPIO4_IO25 CSI_DATA04
    { IMX_MAKE_PIN_1(4, 26), 0x484, 0x000010B0, 0x1F8, 0x05, 0x05 }, // GPIO4_IO26 CSI_DATA05
    { IMX_MAKE_PIN_1(4, 27), 0x488, 0x000010B0, 0x1FC, 0x05, 0x05 }, // GPIO4_IO27 CSI_DATA06
    { IMX_MAKE_PIN_1(4, 28), 0x48C, 0x000010B0, 0x200, 0x05, 0x05 }, // GPIO4_IO28 CSI_DATA07
  };
