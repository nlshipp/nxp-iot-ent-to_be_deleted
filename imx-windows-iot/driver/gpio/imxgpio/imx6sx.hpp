...
namespace {
    ...
    const IMX_PIN_DATA Imx6SXGpioPinDataSparseMap[] = {
        ...
        //--------------------------------------------------
        { IMX_MAKE_PIN_1(1,  0), 0x35C, 0x000010B0,  0x14, 0x05, 0x05 }, // GPIO1_IO00 GPIO1_IO00
        { IMX_MAKE_PIN_1(1,  1), 0x360, 0x000010B0,  0x18, 0x05, 0x05 }, // GPIO1_IO01 GPIO1_IO01
        { IMX_MAKE_PIN_1(1,  2), 0x364, 0x000010B0,  0x1C, 0x05, 0x05 }, // GPIO1_IO02 GPIO1_IO02
        { IMX_MAKE_PIN_1(1,  3), 0x368, 0x000010B0,  0x20, 0x05, 0x05 }, // GPIO1_IO03 GPIO1_IO03
        { IMX_MAKE_PIN_1(1,  4), 0x36C, 0x000010B0,  0x24, 0x05, 0x05 }, // GPIO1_IO04 GPIO1_IO04
        { IMX_MAKE_PIN_1(1,  5), 0x370, 0x000010B0,  0x28, 0x05, 0x05 }, // GPIO1_IO05 GPIO1_IO05
        { IMX_MAKE_PIN_1(1,  6), 0x374, 0x000010B0,  0x2C, 0x05, 0x05 }, // GPIO1_IO06 GPIO1_IO06
        { IMX_MAKE_PIN_1(1,  7), 0x378, 0x000010B0,  0x30, 0x05, 0x05 }, // GPIO1_IO07 GPIO1_IO07
        { IMX_MAKE_PIN_1(1,  8), 0x37C, 0x000010B0,  0x34, 0x05, 0x05 }, // GPIO1_IO08 GPIO1_IO08
        { IMX_MAKE_PIN_1(1,  9), 0x380, 0x000010B0,  0x38, 0x05, 0x05 }, // GPIO1_IO09 GPIO1_IO09
        { IMX_MAKE_PIN_1(1, 10), 0x384, 0x000010B0,  0x3C, 0x05, 0x05 }, // GPIO1_IO10 GPIO1_IO10
        { IMX_MAKE_PIN_1(1, 11), 0x388, 0x000010B0,  0x40, 0x05, 0x05 }, // GPIO1_IO11 GPIO1_IO11
        { IMX_MAKE_PIN_1(1, 12), 0x38C, 0x000010B0,  0x44, 0x05, 0x05 }, // GPIO1_IO12 GPIO1_IO12
        { IMX_MAKE_PIN_1(1, 13), 0x390, 0x000010B0,  0x48, 0x05, 0x05 }, // GPIO1_IO13 GPIO1_IO13
        { IMX_MAKE_PIN_1(1, 14), 0x394, 0x000010B0,  0x4C, 0x05, 0x05 }, // GPIO1_IO14 CSI_DATA00
        { IMX_MAKE_PIN_1(1, 15), 0x398, 0x000010B0,  0x50, 0x05, 0x05 }, // GPIO1_IO15 CSI_DATA01
        { IMX_MAKE_PIN_1(1, 16), 0x39C, 0x000010B0,  0x54, 0x05, 0x05 }, // GPIO1_IO16 CSI_DATA02
        { IMX_MAKE_PIN_1(1, 17), 0x3A0, 0x000010B0,  0x58, 0x05, 0x05 }, // GPIO1_IO17 CSI_DATA03
        { IMX_MAKE_PIN_1(1, 18), 0x3A4, 0x000010B0,  0x5C, 0x05, 0x05 }, // GPIO1_IO18 CSI_DATA04
        { IMX_MAKE_PIN_1(1, 19), 0x3A8, 0x000010B0,  0x60, 0x05, 0x05 }, // GPIO1_IO19 CSI_DATA05
        { IMX_MAKE_PIN_1(1, 20), 0x3AC, 0x000010B0,  0x64, 0x05, 0x05 }, // GPIO1_IO20 CSI_DATA06
        { IMX_MAKE_PIN_1(1, 21), 0x3B0, 0x000010B0,  0x68, 0x05, 0x05 }, // GPIO1_IO21 CSI_DATA07
        { IMX_MAKE_PIN_1(1, 22), 0x3B4, 0x000010B0,  0x6C, 0x05, 0x05 }, // GPIO1_IO22 CSI_HSYNC
        { IMX_MAKE_PIN_1(1, 23), 0x3B8, 0x000010B0,  0x70, 0x05, 0x05 }, // GPIO1_IO23 CSI_MCLK
        { IMX_MAKE_PIN_1(1, 24), 0x3BC, 0x000010B0,  0x74, 0x05, 0x05 }, // GPIO1_IO24 CSI_PIXCLK
        { IMX_MAKE_PIN_1(1, 25), 0x3C0, 0x000010B0,  0x78, 0x05, 0x05 }, // GPIO1_IO25 CSI_VSYNC
        { IMX_MAKE_PIN_1(2,  0), 0x3C4, 0x000010B0,  0x7C, 0x05, 0x05 }, // GPIO2_IO00 ENET1_COL
        { IMX_MAKE_PIN_1(2,  1), 0x3C8, 0x000010B0,  0x80, 0x05, 0x05 }, // GPIO2_IO01 ENET1_CRS
        { IMX_MAKE_PIN_1(2,  2), 0x3CC, 0x000010B0,  0x84, 0x05, 0x05 }, // GPIO2_IO02 ENET1_MDC
        { IMX_MAKE_PIN_1(2,  3), 0x3D0, 0x000010B0,  0x88, 0x05, 0x05 }, // GPIO2_IO03 ENET1_MDIO
        { IMX_MAKE_PIN_1(2,  4), 0x3D4, 0x000010B0,  0x8C, 0x05, 0x05 }, // GPIO2_IO04 ENET1_RX_CLK
        { IMX_MAKE_PIN_1(2,  5), 0x3D8, 0x000010B0,  0x90, 0x05, 0x05 }, // GPIO2_IO05 ENET1_TX_CLK
        { IMX_MAKE_PIN_1(2,  6), 0x3DC, 0x000010B0,  0x94, 0x05, 0x05 }, // GPIO2_IO06 ENET2_COL
        { IMX_MAKE_PIN_1(2,  7), 0x3E0, 0x000010B0,  0x98, 0x05, 0x05 }, // GPIO2_IO07 ENET2_CRS
        { IMX_MAKE_PIN_1(2,  8), 0x3E4, 0x000010B0,  0x9C, 0x05, 0x05 }, // GPIO2_IO08 ENET2_RX_CLK
        { IMX_MAKE_PIN_1(2,  9), 0x3E8, 0x000010B0,  0xA0, 0x05, 0x05 }, // GPIO2_IO09 ENET2_TX_CLK
        { IMX_MAKE_PIN_1(2, 10), 0x3EC, 0x000010B0,  0xA4, 0x05, 0x05 }, // GPIO2_IO10 KEY_COL0
        { IMX_MAKE_PIN_1(2, 11), 0x3F0, 0x000010B0,  0xA8, 0x05, 0x05 }, // GPIO2_IO11 KEY_COL1
        { IMX_MAKE_PIN_1(2, 12), 0x3F4, 0x000010B0,  0xAC, 0x05, 0x05 }, // GPIO2_IO12 KEY_COL2
        { IMX_MAKE_PIN_1(2, 13), 0x3F8, 0x000010B0,  0xB0, 0x05, 0x05 }, // GPIO2_IO13 KEY_COL3
        { IMX_MAKE_PIN_1(2, 14), 0x3FC, 0x000010B0,  0xB4, 0x05, 0x05 }, // GPIO2_IO14 KEY_COL4
        { IMX_MAKE_PIN_1(2, 15), 0x400, 0x000010B0,  0xB8, 0x05, 0x05 }, // GPIO2_IO15 KEY_ROW0
        { IMX_MAKE_PIN_1(2, 16), 0x404, 0x000010B0,  0xBC, 0x05, 0x05 }, // GPIO2_IO16 KEY_ROW1
        { IMX_MAKE_PIN_1(2, 17), 0x408, 0x000010B0,  0xC0, 0x05, 0x05 }, // GPIO2_IO17 KEY_ROW2
        { IMX_MAKE_PIN_1(2, 18), 0x40C, 0x000010B0,  0xC4, 0x05, 0x05 }, // GPIO2_IO18 KEY_ROW3
        { IMX_MAKE_PIN_1(2, 19), 0x410, 0x000010B0,  0xC8, 0x05, 0x05 }, // GPIO2_IO19 KEY_ROW4
        { IMX_MAKE_PIN_1(3,  0), 0x414, 0x000010B0,  0xCC, 0x05, 0x05 }, // GPIO3_IO00 LCD1_CLK
        { IMX_MAKE_PIN_1(3,  1), 0x418, 0x000010B0,  0xD0, 0x05, 0x05 }, // GPIO3_IO01 LCD1_DATA00
        { IMX_MAKE_PIN_1(3,  2), 0x41C, 0x000010B0,  0xD4, 0x05, 0x05 }, // GPIO3_IO02 LCD1_DATA01
        { IMX_MAKE_PIN_1(3,  3), 0x420, 0x000010B0,  0xD8, 0x05, 0x05 }, // GPIO3_IO03 LCD1_DATA02
        { IMX_MAKE_PIN_1(3,  4), 0x424, 0x000010B0,  0xDC, 0x05, 0x05 }, // GPIO3_IO04 LCD1_DATA03
        { IMX_MAKE_PIN_1(3,  5), 0x428, 0x000010B0,  0xE0, 0x05, 0x05 }, // GPIO3_IO05 LCD1_DATA04
        { IMX_MAKE_PIN_1(3,  6), 0x42C, 0x000010B0,  0xE4, 0x05, 0x05 }, // GPIO3_IO06 LCD1_DATA05
        { IMX_MAKE_PIN_1(3,  7), 0x430, 0x000010B0,  0xE8, 0x05, 0x05 }, // GPIO3_IO07 LCD1_DATA06
        { IMX_MAKE_PIN_1(3,  8), 0x434, 0x000010B0,  0xEC, 0x05, 0x05 }, // GPIO3_IO08 LCD1_DATA07
        { IMX_MAKE_PIN_1(3,  9), 0x438, 0x000010B0,  0xF0, 0x05, 0x05 }, // GPIO3_IO09 LCD1_DATA08
        { IMX_MAKE_PIN_1(3, 10), 0x43C, 0x000010B0,  0xF4, 0x05, 0x05 }, // GPIO3_IO10 LCD1_DATA09
        { IMX_MAKE_PIN_1(3, 11), 0x440, 0x000010B0,  0xF8, 0x05, 0x05 }, // GPIO3_IO11 LCD1_DATA10
        { IMX_MAKE_PIN_1(3, 12), 0x444, 0x000010B0,  0xFC, 0x05, 0x05 }, // GPIO3_IO12 LCD1_DATA11
        { IMX_MAKE_PIN_1(3, 13), 0x448, 0x000010B0, 0x100, 0x05, 0x05 }, // GPIO3_IO13 LCD1_DATA12
        { IMX_MAKE_PIN_1(3, 14), 0x44C, 0x000010B0, 0x104, 0x05, 0x05 }, // GPIO3_IO14 LCD1_DATA13
        { IMX_MAKE_PIN_1(3, 15), 0x450, 0x000010B0, 0x108, 0x05, 0x05 }, // GPIO3_IO15 LCD1_DATA14
        { IMX_MAKE_PIN_1(3, 16), 0x454, 0x000010B0, 0x10C, 0x05, 0x05 }, // GPIO3_IO16 LCD1_DATA15
        { IMX_MAKE_PIN_1(3, 17), 0x458, 0x000010B0, 0x110, 0x05, 0x05 }, // GPIO3_IO17 LCD1_DATA16
        { IMX_MAKE_PIN_1(3, 18), 0x45C, 0x000010B0, 0x114, 0x05, 0x05 }, // GPIO3_IO18 LCD1_DATA17
        { IMX_MAKE_PIN_1(3, 19), 0x460, 0x000010B0, 0x118, 0x05, 0x05 }, // GPIO3_IO19 LCD1_DATA18
        { IMX_MAKE_PIN_1(3, 20), 0x464, 0x000010B0, 0x11C, 0x05, 0x05 }, // GPIO3_IO20 LCD1_DATA19
        { IMX_MAKE_PIN_1(3, 21), 0x468, 0x000010B0, 0x120, 0x05, 0x05 }, // GPIO3_IO21 LCD1_DATA20
        { IMX_MAKE_PIN_1(3, 22), 0x46C, 0x000010B0, 0x124, 0x05, 0x05 }, // GPIO3_IO22 LCD1_DATA21
        { IMX_MAKE_PIN_1(3, 23), 0x470, 0x000010B0, 0x128, 0x05, 0x05 }, // GPIO3_IO23 LCD1_DATA22
        { IMX_MAKE_PIN_1(3, 24), 0x474, 0x000010B0, 0x12C, 0x05, 0x05 }, // GPIO3_IO24 LCD1_DATA23
        { IMX_MAKE_PIN_1(3, 25), 0x478, 0x000010B0, 0x130, 0x05, 0x05 }, // GPIO3_IO25 LCD1_ENABLE
        { IMX_MAKE_PIN_1(3, 26), 0x47C, 0x000010B0, 0x134, 0x05, 0x05 }, // GPIO3_IO26 LCD1_HSYNC
        { IMX_MAKE_PIN_1(3, 27), 0x480, 0x000010B0, 0x138, 0x05, 0x05 }, // GPIO3_IO27 LCD1_RESET
        { IMX_MAKE_PIN_1(3, 28), 0x484, 0x000010B0, 0x13C, 0x05, 0x05 }, // GPIO3_IO28 LCD1_VSYNC
        { IMX_MAKE_PIN_1(4,  0), 0x488, 0x000010B0, 0x140, 0x05, 0x05 }, // GPIO4_IO00 NAND_ALE
        { IMX_MAKE_PIN_1(4,  1), 0x48C, 0x000010B0, 0x144, 0x05, 0x05 }, // GPIO4_IO01 NAND_CE0_B
        { IMX_MAKE_PIN_1(4,  2), 0x490, 0x000010B0, 0x148, 0x05, 0x05 }, // GPIO4_IO02 NAND_CE1_B
        { IMX_MAKE_PIN_1(4,  3), 0x494, 0x000010B0, 0x14C, 0x05, 0x05 }, // GPIO4_IO03 NAND_CLE
        { IMX_MAKE_PIN_1(4,  4), 0x498, 0x000010B0, 0x150, 0x05, 0x05 }, // GPIO4_IO04 NAND_DATA00
        { IMX_MAKE_PIN_1(4,  5), 0x49C, 0x000010B0, 0x154, 0x05, 0x05 }, // GPIO4_IO05 NAND_DATA01
        { IMX_MAKE_PIN_1(4,  6), 0x4A0, 0x000010B0, 0x158, 0x05, 0x05 }, // GPIO4_IO06 NAND_DATA02
        { IMX_MAKE_PIN_1(4,  7), 0x4A4, 0x000010B0, 0x15C, 0x05, 0x05 }, // GPIO4_IO07 NAND_DATA03
        { IMX_MAKE_PIN_1(4,  8), 0x4A8, 0x000010B0, 0x160, 0x05, 0x05 }, // GPIO4_IO08 NAND_DATA04
        { IMX_MAKE_PIN_1(4,  9), 0x4AC, 0x000010B0, 0x164, 0x05, 0x05 }, // GPIO4_IO09 NAND_DATA05
        { IMX_MAKE_PIN_1(4, 10), 0x4B0, 0x000010B0, 0x168, 0x05, 0x05 }, // GPIO4_IO10 NAND_DATA06
        { IMX_MAKE_PIN_1(4, 11), 0x4B4, 0x000010B0, 0x16C, 0x05, 0x05 }, // GPIO4_IO11 NAND_DATA07
        { IMX_MAKE_PIN_1(4, 12), 0x4B8, 0x000010B0, 0x170, 0x05, 0x05 }, // GPIO4_IO12 NAND_RE_B
        { IMX_MAKE_PIN_1(4, 13), 0x4BC, 0x000010B0, 0x174, 0x05, 0x05 }, // GPIO4_IO13 NAND_READY_B
        { IMX_MAKE_PIN_1(4, 14), 0x4C0, 0x000010B0, 0x178, 0x05, 0x05 }, // GPIO4_IO14 NAND_WE_B
        { IMX_MAKE_PIN_1(4, 15), 0x4C4, 0x000010B0, 0x17C, 0x05, 0x05 }, // GPIO4_IO15 NAND_WP_B
        { IMX_MAKE_PIN_1(4, 16), 0x4C8, 0x000010B0, 0x180, 0x05, 0x05 }, // GPIO4_IO16 QSPI1A_DATA0
        { IMX_MAKE_PIN_1(4, 17), 0x4CC, 0x000010B0, 0x184, 0x05, 0x05 }, // GPIO4_IO17 QSPI1A_DATA1
        { IMX_MAKE_PIN_1(4, 18), 0x4D0, 0x000010B0, 0x188, 0x05, 0x05 }, // GPIO4_IO18 QSPI1A_DATA2
        { IMX_MAKE_PIN_1(4, 19), 0x4D4, 0x000010B0, 0x18C, 0x05, 0x05 }, // GPIO4_IO19 QSPI1A_DATA3
        { IMX_MAKE_PIN_1(4, 20), 0x4D8, 0x000010B0, 0x190, 0x05, 0x05 }, // GPIO4_IO20 QSPI1A_DQS
        { IMX_MAKE_PIN_1(4, 21), 0x4DC, 0x000010B0, 0x194, 0x05, 0x05 }, // GPIO4_IO21 QSPI1A_SCLK
        { IMX_MAKE_PIN_1(4, 22), 0x4E0, 0x000010B0, 0x198, 0x05, 0x05 }, // GPIO4_IO22 QSPI1A_SS0_B
        { IMX_MAKE_PIN_1(4, 23), 0x4E4, 0x000010B0, 0x19C, 0x05, 0x05 }, // GPIO4_IO23 QSPI1A_SS1_B
        { IMX_MAKE_PIN_1(4, 24), 0x4E8, 0x000010B0, 0x1A0, 0x05, 0x05 }, // GPIO4_IO24 QSPI1B_DATA0
        { IMX_MAKE_PIN_1(4, 25), 0x4EC, 0x000010B0, 0x1A4, 0x05, 0x05 }, // GPIO4_IO25 QSPI1B_DATA1
        { IMX_MAKE_PIN_1(4, 26), 0x4F0, 0x000010B0, 0x1A8, 0x05, 0x05 }, // GPIO4_IO26 QSPI1B_DATA2
        { IMX_MAKE_PIN_1(4, 27), 0x4F4, 0x000010B0, 0x1AC, 0x05, 0x05 }, // GPIO4_IO27 QSPI1B_DATA3
        { IMX_MAKE_PIN_1(4, 28), 0x4F8, 0x000010B0, 0x1B0, 0x05, 0x05 }, // GPIO4_IO28 QSPI1B_DQS
        { IMX_MAKE_PIN_1(4, 29), 0x4FC, 0x000010B0, 0x1B4, 0x05, 0x05 }, // GPIO4_IO29 QSPI1B_SCLK
        { IMX_MAKE_PIN_1(4, 30), 0x500, 0x000010B0, 0x1B8, 0x05, 0x05 }, // GPIO4_IO30 QSPI1B_SS0_B
        { IMX_MAKE_PIN_1(4, 31), 0x504, 0x000010B0, 0x1BC, 0x05, 0x05 }, // GPIO4_IO31 QSPI1B_SS1_B
        { IMX_MAKE_PIN_1(5,  0), 0x508, 0x000010B0, 0x1C0, 0x05, 0x05 }, // GPIO5_IO00 RGMII1_RD0
        { IMX_MAKE_PIN_1(5,  1), 0x50C, 0x000010B0, 0x1C4, 0x05, 0x05 }, // GPIO5_IO01 RGMII1_RD1
        { IMX_MAKE_PIN_1(5,  2), 0x510, 0x000010B0, 0x1C8, 0x05, 0x05 }, // GPIO5_IO02 RGMII1_RD2
        { IMX_MAKE_PIN_1(5,  3), 0x514, 0x000010B0, 0x1CC, 0x05, 0x05 }, // GPIO5_IO03 RGMII1_RD3
        { IMX_MAKE_PIN_1(5,  4), 0x518, 0x000010B0, 0x1D0, 0x05, 0x05 }, // GPIO5_IO04 RGMII1_RX_CTL
        { IMX_MAKE_PIN_1(5,  5), 0x51C, 0x000010B0, 0x1D4, 0x05, 0x05 }, // GPIO5_IO05 RGMII1_RXC
        { IMX_MAKE_PIN_1(5,  6), 0x520, 0x000010B0, 0x1D8, 0x05, 0x05 }, // GPIO5_IO06 RGMII1_TD0
        { IMX_MAKE_PIN_1(5,  7), 0x524, 0x000010B0, 0x1DC, 0x05, 0x05 }, // GPIO5_IO07 RGMII1_TD1
        { IMX_MAKE_PIN_1(5,  8), 0x528, 0x000010B0, 0x1E0, 0x05, 0x05 }, // GPIO5_IO08 RGMII1_TD2
        { IMX_MAKE_PIN_1(5,  9), 0x52C, 0x000010B0, 0x1E4, 0x05, 0x05 }, // GPIO5_IO09 RGMII1_TD3
        { IMX_MAKE_PIN_1(5, 10), 0x530, 0x000010B0, 0x1E8, 0x05, 0x05 }, // GPIO5_IO10 RGMII1_TX_CTL
        { IMX_MAKE_PIN_1(5, 11), 0x534, 0x000010B0, 0x1EC, 0x05, 0x05 }, // GPIO5_IO11 RGMII1_TXC
        { IMX_MAKE_PIN_1(5, 12), 0x538, 0x000010B0, 0x1F0, 0x05, 0x05 }, // GPIO5_IO12 RGMII2_RD0
        { IMX_MAKE_PIN_1(5, 13), 0x53C, 0x000010B0, 0x1F4, 0x05, 0x05 }, // GPIO5_IO13 RGMII2_RD1
        { IMX_MAKE_PIN_1(5, 14), 0x540, 0x000010B0, 0x1F8, 0x05, 0x05 }, // GPIO5_IO14 RGMII2_RD2
        { IMX_MAKE_PIN_1(5, 15), 0x544, 0x000010B0, 0x1FC, 0x05, 0x05 }, // GPIO5_IO15 RGMII2_RD3
        { IMX_MAKE_PIN_1(5, 16), 0x548, 0x000010B0, 0x200, 0x05, 0x05 }, // GPIO5_IO16 RGMII2_RX_CTL
        { IMX_MAKE_PIN_1(5, 17), 0x54C, 0x000010B0, 0x204, 0x05, 0x05 }, // GPIO5_IO17 RGMII2_RXC
        { IMX_MAKE_PIN_1(5, 18), 0x550, 0x000010B0, 0x208, 0x05, 0x05 }, // GPIO5_IO18 RGMII2_TD0
        { IMX_MAKE_PIN_1(5, 19), 0x554, 0x000010B0, 0x20C, 0x05, 0x05 }, // GPIO5_IO19 RGMII2_TD1
        { IMX_MAKE_PIN_1(5, 20), 0x558, 0x000010B0, 0x210, 0x05, 0x05 }, // GPIO5_IO20 RGMII2_TD2
        { IMX_MAKE_PIN_1(5, 21), 0x55C, 0x000010B0, 0x214, 0x05, 0x05 }, // GPIO5_IO21 RGMII2_TD3
        { IMX_MAKE_PIN_1(5, 22), 0x560, 0x000010B0, 0x218, 0x05, 0x05 }, // GPIO5_IO22 RGMII2_TX_CTL
        { IMX_MAKE_PIN_1(5, 23), 0x564, 0x000010B0, 0x21C, 0x05, 0x05 }, // GPIO5_IO23 RGMII2_TXC
        { IMX_MAKE_PIN_1(6,  0), 0x568, 0x000010B0, 0x220, 0x05, 0x05 }, // GPIO6_IO00 SD1_CLK
        { IMX_MAKE_PIN_1(6,  1), 0x56C, 0x000010B0, 0x224, 0x05, 0x05 }, // GPIO6_IO01 SD1_CMD
        { IMX_MAKE_PIN_1(6,  2), 0x570, 0x000010B0, 0x228, 0x05, 0x05 }, // GPIO6_IO02 SD1_DATA0
        { IMX_MAKE_PIN_1(6,  3), 0x574, 0x000010B0, 0x22C, 0x05, 0x05 }, // GPIO6_IO03 SD1_DATA1
        { IMX_MAKE_PIN_1(6,  4), 0x578, 0x000010B0, 0x230, 0x05, 0x05 }, // GPIO6_IO04 SD1_DATA2
        { IMX_MAKE_PIN_1(6,  5), 0x57C, 0x000010B0, 0x234, 0x05, 0x05 }, // GPIO6_IO05 SD1_DATA3
        { IMX_MAKE_PIN_1(6,  6), 0x580, 0x000010B0, 0x238, 0x05, 0x05 }, // GPIO6_IO06 SD2_CLK
        { IMX_MAKE_PIN_1(6,  7), 0x584, 0x000010B0, 0x23C, 0x05, 0x05 }, // GPIO6_IO07 SD2_CMD
        { IMX_MAKE_PIN_1(6,  8), 0x588, 0x000010B0, 0x240, 0x05, 0x05 }, // GPIO6_IO08 SD2_DATA0
        { IMX_MAKE_PIN_1(6,  9), 0x58C, 0x000010B0, 0x244, 0x05, 0x05 }, // GPIO6_IO09 SD2_DATA1
        { IMX_MAKE_PIN_1(6, 10), 0x590, 0x000010B0, 0x248, 0x05, 0x05 }, // GPIO6_IO10 SD2_DATA2
        { IMX_MAKE_PIN_1(6, 11), 0x594, 0x000010B0, 0x24C, 0x05, 0x05 }, // GPIO6_IO11 SD2_DATA3
        { IMX_MAKE_PIN_1(6, 12), 0x5C0, 0x000010B0, 0x278, 0x05, 0x05 }, // GPIO6_IO12 SD4_CLK
        { IMX_MAKE_PIN_1(6, 13), 0x5C4, 0x000010B0, 0x27C, 0x05, 0x05 }, // GPIO6_IO13 SD4_CMD
        { IMX_MAKE_PIN_1(6, 14), 0x5C8, 0x000010B0, 0x280, 0x05, 0x05 }, // GPIO6_IO14 SD4_DATA0
        { IMX_MAKE_PIN_1(6, 15), 0x5CC, 0x000010B0, 0x284, 0x05, 0x05 }, // GPIO6_IO15 SD4_DATA1
        { IMX_MAKE_PIN_1(6, 16), 0x5D0, 0x000010B0, 0x288, 0x05, 0x05 }, // GPIO6_IO16 SD4_DATA2
        { IMX_MAKE_PIN_1(6, 17), 0x5D4, 0x000010B0, 0x28C, 0x05, 0x05 }, // GPIO6_IO17 SD4_DATA3
        { IMX_MAKE_PIN_1(6, 18), 0x5D8, 0x000010B0, 0x290, 0x05, 0x05 }, // GPIO6_IO18 SD4_DATA4
        { IMX_MAKE_PIN_1(6, 19), 0x5DC, 0x000010B0, 0x294, 0x05, 0x05 }, // GPIO6_IO19 SD4_DATA5
        { IMX_MAKE_PIN_1(6, 20), 0x5E0, 0x000010B0, 0x298, 0x05, 0x05 }, // GPIO6_IO20 SD4_DATA6
        { IMX_MAKE_PIN_1(6, 21), 0x5E4, 0x000010B0, 0x29C, 0x05, 0x05 }, // GPIO6_IO21 SD4_DATA7
        { IMX_MAKE_PIN_1(6, 22), 0x5E8, 0x000010B0, 0x2A0, 0x05, 0x05 }, // GPIO6_IO22 SD4_RESET_B
        { IMX_MAKE_PIN_1(7,  0), 0x598, 0x000030B0, 0x250, 0x05, 0x05 }, // GPIO7_IO00 SD3_CLK
        { IMX_MAKE_PIN_1(7,  1), 0x59C, 0x000030B0, 0x254, 0x05, 0x05 }, // GPIO7_IO01 SD3_CMD
        { IMX_MAKE_PIN_1(7,  2), 0x5A0, 0x000030B0, 0x258, 0x05, 0x05 }, // GPIO7_IO02 SD3_DATA0
        { IMX_MAKE_PIN_1(7,  3), 0x5A4, 0x000030B0, 0x25C, 0x05, 0x05 }, // GPIO7_IO03 SD3_DATA1
        { IMX_MAKE_PIN_1(7,  4), 0x5A8, 0x000030B0, 0x260, 0x05, 0x05 }, // GPIO7_IO04 SD3_DATA2
        { IMX_MAKE_PIN_1(7,  5), 0x5AC, 0x000030B0, 0x264, 0x05, 0x05 }, // GPIO7_IO05 SD3_DATA3
        { IMX_MAKE_PIN_1(7,  6), 0x5B0, 0x000030B0, 0x268, 0x05, 0x05 }, // GPIO7_IO06 SD3_DATA4
        { IMX_MAKE_PIN_1(7,  7), 0x5B4, 0x000030B0, 0x26C, 0x05, 0x05 }, // GPIO7_IO07 SD3_DATA5
        { IMX_MAKE_PIN_1(7,  8), 0x5B8, 0x000030B0, 0x270, 0x05, 0x05 }, // GPIO7_IO08 SD3_DATA6
        { IMX_MAKE_PIN_1(7,  9), 0x5BC, 0x000030B0, 0x274, 0x05, 0x05 }, // GPIO7_IO09 SD3_DATA7
        { IMX_MAKE_PIN_1(7, 10), 0x5EC, 0x00083030, 0x2A4, 0x00, 0x05 }, // GPIO7_IO10 USB_H_DATA
        { IMX_MAKE_PIN_1(7, 11), 0x5F0, 0x00083030, 0x2A8, 0x00, 0x05 }, // GPIO7_IO11 USB_H_STROBE
    };
