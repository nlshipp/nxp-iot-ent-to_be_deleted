...
namespace {
    ...
    const IMX_PIN_DATA Imx7DGpioPinDataSparseMap[] = {
        ...
        //--------------------------------------------------
        { IMX_MAKE_PIN_1(1,  0),  0x30, 0x00000074,   0x0, 0x00, 0x00 }, // GPIO1_IO00 GPIO1_IO00
        { IMX_MAKE_PIN_1(1,  1),  0x34, 0x00000014,   0x4, 0x00, 0x00 }, // GPIO1_IO01 GPIO1_IO01
        { IMX_MAKE_PIN_1(1,  2),  0x38, 0x00000014,   0x8, 0x00, 0x00 }, // GPIO1_IO02 GPIO1_IO02
        { IMX_MAKE_PIN_1(1,  3),  0x3C, 0x00000014,   0xC, 0x00, 0x00 }, // GPIO1_IO03 GPIO1_IO03
        { IMX_MAKE_PIN_1(1,  4),  0x40, 0x00000014,  0x10, 0x00, 0x00 }, // GPIO1_IO04 GPIO1_IO04
        { IMX_MAKE_PIN_1(1,  5),  0x44, 0x00000014,  0x14, 0x00, 0x00 }, // GPIO1_IO05 GPIO1_IO05
        { IMX_MAKE_PIN_1(1,  6),  0x48, 0x00000014,  0x18, 0x00, 0x00 }, // GPIO1_IO06 GPIO1_IO06
        { IMX_MAKE_PIN_1(1,  7),  0x4C, 0x00000014,  0x1C, 0x00, 0x00 }, // GPIO1_IO07 GPIO1_IO07
        { IMX_MAKE_PIN_1(1,  8), 0x26C, 0x00000014,  0x14, 0x00, 0x00 }, // GPIO1_IO08 GPIO1_IO08
        { IMX_MAKE_PIN_1(1,  9), 0x270, 0x00000014,  0x18, 0x00, 0x00 }, // GPIO1_IO09 GPIO1_IO09
        { IMX_MAKE_PIN_1(1, 10), 0x274, 0x00000014,  0x1C, 0x00, 0x00 }, // GPIO1_IO10 GPIO1_IO10
        { IMX_MAKE_PIN_1(1, 11), 0x278, 0x00000014,  0x20, 0x00, 0x00 }, // GPIO1_IO11 GPIO1_IO11
        { IMX_MAKE_PIN_1(1, 12), 0x27C, 0x00000014,  0x24, 0x00, 0x00 }, // GPIO1_IO12 GPIO1_IO12
        { IMX_MAKE_PIN_1(1, 13), 0x280, 0x00000014,  0x28, 0x00, 0x00 }, // GPIO1_IO13 GPIO1_IO13
        { IMX_MAKE_PIN_1(1, 14), 0x284, 0x00000014,  0x2C, 0x00, 0x00 }, // GPIO1_IO14 GPIO1_IO14
        { IMX_MAKE_PIN_1(1, 15), 0x288, 0x00000014,  0x30, 0x00, 0x00 }, // GPIO1_IO15 GPIO1_IO15
        { IMX_MAKE_PIN_1(2,  0), 0x2A4, 0x00000014,  0x34, 0x05, 0x05 }, // GPIO2_IO00 EPDC_DATA00
        { IMX_MAKE_PIN_1(2,  1), 0x2A8, 0x00000014,  0x38, 0x05, 0x05 }, // GPIO2_IO01 EPDC_DATA01
        { IMX_MAKE_PIN_1(2,  2), 0x2AC, 0x00000014,  0x3C, 0x05, 0x05 }, // GPIO2_IO02 EPDC_DATA02
        { IMX_MAKE_PIN_1(2,  3), 0x2B0, 0x00000014,  0x40, 0x05, 0x05 }, // GPIO2_IO03 EPDC_DATA03
        { IMX_MAKE_PIN_1(2,  4), 0x2B4, 0x00000014,  0x44, 0x05, 0x05 }, // GPIO2_IO04 EPDC_DATA04
        { IMX_MAKE_PIN_1(2,  5), 0x2B8, 0x00000014,  0x48, 0x05, 0x05 }, // GPIO2_IO05 EPDC_DATA05
        { IMX_MAKE_PIN_1(2,  6), 0x2BC, 0x00000014,  0x4C, 0x05, 0x05 }, // GPIO2_IO06 EPDC_DATA06
        { IMX_MAKE_PIN_1(2,  7), 0x2C0, 0x00000014,  0x50, 0x05, 0x05 }, // GPIO2_IO07 EPDC_DATA07
        { IMX_MAKE_PIN_1(2,  8), 0x2C4, 0x00000014,  0x54, 0x05, 0x05 }, // GPIO2_IO08 EPDC_DATA08
        { IMX_MAKE_PIN_1(2,  9), 0x2C8, 0x00000014,  0x58, 0x05, 0x05 }, // GPIO2_IO09 EPDC_DATA09
        { IMX_MAKE_PIN_1(2, 10), 0x2CC, 0x00000014,  0x5C, 0x05, 0x05 }, // GPIO2_IO10 EPDC_DATA10
        { IMX_MAKE_PIN_1(2, 11), 0x2D0, 0x00000014,  0x60, 0x05, 0x05 }, // GPIO2_IO11 EPDC_DATA11
        { IMX_MAKE_PIN_1(2, 12), 0x2D4, 0x00000014,  0x64, 0x05, 0x05 }, // GPIO2_IO12 EPDC_DATA12
        { IMX_MAKE_PIN_1(2, 13), 0x2D8, 0x00000014,  0x68, 0x05, 0x05 }, // GPIO2_IO13 EPDC_DATA13
        { IMX_MAKE_PIN_1(2, 14), 0x2DC, 0x00000014,  0x6C, 0x05, 0x05 }, // GPIO2_IO14 EPDC_DATA14
        { IMX_MAKE_PIN_1(2, 15), 0x2E0, 0x00000014,  0x70, 0x05, 0x05 }, // GPIO2_IO15 EPDC_DATA15
        { IMX_MAKE_PIN_1(2, 16), 0x2E4, 0x00000014,  0x74, 0x05, 0x05 }, // GPIO2_IO16 EPDC_SDCLK
        { IMX_MAKE_PIN_1(2, 17), 0x2E8, 0x00000014,  0x78, 0x05, 0x05 }, // GPIO2_IO17 EPDC_SDLE
        { IMX_MAKE_PIN_1(2, 18), 0x2EC, 0x00000014,  0x7C, 0x05, 0x05 }, // GPIO2_IO18 EPDC_SDOE
        { IMX_MAKE_PIN_1(2, 19), 0x2F0, 0x00000014,  0x80, 0x05, 0x05 }, // GPIO2_IO19 EPDC_SDSHR
        { IMX_MAKE_PIN_1(2, 20), 0x2F4, 0x00000014,  0x84, 0x05, 0x05 }, // GPIO2_IO20 EPDC_SDCE0
        { IMX_MAKE_PIN_1(2, 21), 0x2F8, 0x00000014,  0x88, 0x05, 0x05 }, // GPIO2_IO21 EPDC_SDCE1
        { IMX_MAKE_PIN_1(2, 22), 0x2FC, 0x00000014,  0x8C, 0x05, 0x05 }, // GPIO2_IO22 EPDC_SDCE2
        { IMX_MAKE_PIN_1(2, 23), 0x300, 0x00000014,  0x90, 0x05, 0x05 }, // GPIO2_IO23 EPDC_SDCE3
        { IMX_MAKE_PIN_1(2, 24), 0x304, 0x00000014,  0x94, 0x05, 0x05 }, // GPIO2_IO24 EPDC_GDCLK
        { IMX_MAKE_PIN_1(2, 25), 0x308, 0x00000014,  0x98, 0x05, 0x05 }, // GPIO2_IO25 EPDC_GDOE
        { IMX_MAKE_PIN_1(2, 26), 0x30C, 0x00000014,  0x9C, 0x05, 0x05 }, // GPIO2_IO26 EPDC_GDRL
        { IMX_MAKE_PIN_1(2, 27), 0x310, 0x00000014,  0xA0, 0x05, 0x05 }, // GPIO2_IO27 EPDC_GDSP
        { IMX_MAKE_PIN_1(2, 28), 0x314, 0x00000014,  0xA4, 0x05, 0x05 }, // GPIO2_IO28 EPDC_BDR0
        { IMX_MAKE_PIN_1(2, 29), 0x318, 0x00000014,  0xA8, 0x05, 0x05 }, // GPIO2_IO29 EPDC_BDR1
        { IMX_MAKE_PIN_1(2, 30), 0x31C, 0x00000014,  0xAC, 0x05, 0x05 }, // GPIO2_IO30 EPDC_PWR_COM
        { IMX_MAKE_PIN_1(2, 31), 0x320, 0x00000014,  0xB0, 0x05, 0x05 }, // GPIO2_IO31 EPDC_PWR_STAT
        { IMX_MAKE_PIN_1(3,  0), 0x324, 0x00000014,  0xB4, 0x05, 0x05 }, // GPIO3_IO00 LCD_CLK
        { IMX_MAKE_PIN_1(3,  1), 0x328, 0x00000014,  0xB8, 0x05, 0x05 }, // GPIO3_IO01 LCD_ENABLE
        { IMX_MAKE_PIN_1(3,  2), 0x32C, 0x00000014,  0xBC, 0x05, 0x05 }, // GPIO3_IO02 LCD_HSYNC
        { IMX_MAKE_PIN_1(3,  3), 0x330, 0x00000014,  0xC0, 0x05, 0x05 }, // GPIO3_IO03 LCD_VSYNC
        { IMX_MAKE_PIN_1(3,  4), 0x334, 0x00000014,  0xC4, 0x05, 0x05 }, // GPIO3_IO04 LCD_RESET
        { IMX_MAKE_PIN_1(3,  5), 0x338, 0x00000014,  0xC8, 0x05, 0x05 }, // GPIO3_IO05 LCD_DATA00
        { IMX_MAKE_PIN_1(3,  6), 0x33C, 0x00000014,  0xCC, 0x05, 0x05 }, // GPIO3_IO06 LCD_DATA01
        { IMX_MAKE_PIN_1(3,  7), 0x340, 0x00000014,  0xD0, 0x05, 0x05 }, // GPIO3_IO07 LCD_DATA02
        { IMX_MAKE_PIN_1(3,  8), 0x344, 0x00000014,  0xD4, 0x05, 0x05 }, // GPIO3_IO08 LCD_DATA03
        { IMX_MAKE_PIN_1(3,  9), 0x348, 0x00000014,  0xD8, 0x05, 0x05 }, // GPIO3_IO09 LCD_DATA04
        { IMX_MAKE_PIN_1(3, 10), 0x34C, 0x00000014,  0xDC, 0x05, 0x05 }, // GPIO3_IO10 LCD_DATA05
        { IMX_MAKE_PIN_1(3, 11), 0x350, 0x00000014,  0xE0, 0x05, 0x05 }, // GPIO3_IO11 LCD_DATA06
        { IMX_MAKE_PIN_1(3, 12), 0x354, 0x00000014,  0xE4, 0x05, 0x05 }, // GPIO3_IO12 LCD_DATA07
        { IMX_MAKE_PIN_1(3, 13), 0x358, 0x00000014,  0xE8, 0x05, 0x05 }, // GPIO3_IO13 LCD_DATA08
        { IMX_MAKE_PIN_1(3, 14), 0x35C, 0x00000014,  0xEC, 0x05, 0x05 }, // GPIO3_IO14 LCD_DATA09
        { IMX_MAKE_PIN_1(3, 15), 0x360, 0x00000014,  0xF0, 0x05, 0x05 }, // GPIO3_IO15 LCD_DATA10
        { IMX_MAKE_PIN_1(3, 16), 0x364, 0x00000014,  0xF4, 0x05, 0x05 }, // GPIO3_IO16 LCD_DATA11
        { IMX_MAKE_PIN_1(3, 17), 0x368, 0x00000014,  0xF8, 0x05, 0x05 }, // GPIO3_IO17 LCD_DATA12
        { IMX_MAKE_PIN_1(3, 18), 0x36C, 0x00000014,  0xFC, 0x05, 0x05 }, // GPIO3_IO18 LCD_DATA13
        { IMX_MAKE_PIN_1(3, 19), 0x370, 0x00000014, 0x100, 0x05, 0x05 }, // GPIO3_IO19 LCD_DATA14
        { IMX_MAKE_PIN_1(3, 20), 0x374, 0x00000014, 0x104, 0x05, 0x05 }, // GPIO3_IO20 LCD_DATA15
        { IMX_MAKE_PIN_1(3, 21), 0x378, 0x00000014, 0x108, 0x05, 0x05 }, // GPIO3_IO21 LCD_DATA16
        { IMX_MAKE_PIN_1(3, 22), 0x37C, 0x00000014, 0x10C, 0x05, 0x05 }, // GPIO3_IO22 LCD_DATA17
        { IMX_MAKE_PIN_1(3, 23), 0x380, 0x00000014, 0x110, 0x05, 0x05 }, // GPIO3_IO23 LCD_DATA18
        { IMX_MAKE_PIN_1(3, 24), 0x384, 0x00000014, 0x114, 0x05, 0x05 }, // GPIO3_IO24 LCD_DATA19
        { IMX_MAKE_PIN_1(3, 25), 0x388, 0x00000014, 0x118, 0x05, 0x05 }, // GPIO3_IO25 LCD_DATA20
        { IMX_MAKE_PIN_1(3, 26), 0x38C, 0x00000014, 0x11C, 0x05, 0x05 }, // GPIO3_IO26 LCD_DATA21
        { IMX_MAKE_PIN_1(3, 27), 0x390, 0x00000014, 0x120, 0x05, 0x05 }, // GPIO3_IO27 LCD_DATA22
        { IMX_MAKE_PIN_1(3, 28), 0x394, 0x00000014, 0x124, 0x05, 0x05 }, // GPIO3_IO28 LCD_DATA23
        { IMX_MAKE_PIN_1(4,  0), 0x398, 0x00000014, 0x128, 0x05, 0x05 }, // GPIO4_IO00 UART1_RX_DATA
        { IMX_MAKE_PIN_1(4,  1), 0x39C, 0x00000014, 0x12C, 0x05, 0x05 }, // GPIO4_IO01 UART1_TX_DATA
        { IMX_MAKE_PIN_1(4,  2), 0x3A0, 0x00000014, 0x130, 0x05, 0x05 }, // GPIO4_IO02 UART2_RX_DATA
        { IMX_MAKE_PIN_1(4,  3), 0x3A4, 0x00000014, 0x134, 0x05, 0x05 }, // GPIO4_IO03 UART2_TX_DATA
        { IMX_MAKE_PIN_1(4,  4), 0x3A8, 0x00000014, 0x138, 0x05, 0x05 }, // GPIO4_IO04 UART3_RX_DATA
        { IMX_MAKE_PIN_1(4,  5), 0x3AC, 0x00000014, 0x13C, 0x05, 0x05 }, // GPIO4_IO05 UART3_TX_DATA
        { IMX_MAKE_PIN_1(4,  6), 0x3B0, 0x00000014, 0x140, 0x05, 0x05 }, // GPIO4_IO06 UART3_RTS_B
        { IMX_MAKE_PIN_1(4,  7), 0x3B4, 0x00000014, 0x144, 0x05, 0x05 }, // GPIO4_IO07 UART3_CTS_B
        { IMX_MAKE_PIN_1(4,  8), 0x3B8, 0x00000014, 0x148, 0x05, 0x05 }, // GPIO4_IO08 I2C1_SCL
        { IMX_MAKE_PIN_1(4,  9), 0x3BC, 0x00000014, 0x14C, 0x05, 0x05 }, // GPIO4_IO09 I2C1_SDA
        { IMX_MAKE_PIN_1(4, 10), 0x3C0, 0x00000014, 0x150, 0x05, 0x05 }, // GPIO4_IO10 I2C2_SCL
        { IMX_MAKE_PIN_1(4, 11), 0x3C4, 0x00000014, 0x154, 0x05, 0x05 }, // GPIO4_IO11 I2C2_SDA
        { IMX_MAKE_PIN_1(4, 12), 0x3C8, 0x00000014, 0x158, 0x05, 0x05 }, // GPIO4_IO12 I2C3_SCL
        { IMX_MAKE_PIN_1(4, 13), 0x3CC, 0x00000014, 0x15C, 0x05, 0x05 }, // GPIO4_IO13 I2C3_SDA
        { IMX_MAKE_PIN_1(4, 14), 0x3D0, 0x00000014, 0x160, 0x05, 0x05 }, // GPIO4_IO14 I2C4_SCL
        { IMX_MAKE_PIN_1(4, 15), 0x3D4, 0x00000014, 0x164, 0x05, 0x05 }, // GPIO4_IO15 I2C4_SDA
        { IMX_MAKE_PIN_1(4, 16), 0x3D8, 0x00000014, 0x168, 0x05, 0x05 }, // GPIO4_IO16 ECSPI1_SCLK
        { IMX_MAKE_PIN_1(4, 17), 0x3DC, 0x00000014, 0x16C, 0x05, 0x05 }, // GPIO4_IO17 ECSPI1_MOSI
        { IMX_MAKE_PIN_1(4, 18), 0x3E0, 0x00000014, 0x170, 0x05, 0x05 }, // GPIO4_IO18 ECSPI1_MISO
        { IMX_MAKE_PIN_1(4, 19), 0x3E4, 0x00000014, 0x174, 0x05, 0x05 }, // GPIO4_IO19 ECSPI1_SS0
        { IMX_MAKE_PIN_1(4, 20), 0x3E8, 0x00000014, 0x178, 0x05, 0x05 }, // GPIO4_IO20 ECSPI2_SCLK
        { IMX_MAKE_PIN_1(4, 21), 0x3EC, 0x00000014, 0x17C, 0x05, 0x05 }, // GPIO4_IO21 ECSPI2_MOSI
        { IMX_MAKE_PIN_1(4, 22), 0x3F0, 0x00000014, 0x180, 0x05, 0x05 }, // GPIO4_IO22 ECSPI2_MISO
        { IMX_MAKE_PIN_1(4, 23), 0x3F4, 0x00000014, 0x184, 0x05, 0x05 }, // GPIO4_IO23 ECSPI2_SS0
        { IMX_MAKE_PIN_1(5,  0), 0x3F8, 0x00000014, 0x188, 0x05, 0x05 }, // GPIO5_IO00 SD1_CD_B
        { IMX_MAKE_PIN_1(5,  1), 0x3FC, 0x00000014, 0x18C, 0x05, 0x05 }, // GPIO5_IO01 SD1_WP
        { IMX_MAKE_PIN_1(5,  2), 0x400, 0x00000014, 0x190, 0x05, 0x05 }, // GPIO5_IO02 SD1_RESET_B
        { IMX_MAKE_PIN_1(5,  3), 0x404, 0x00000014, 0x194, 0x05, 0x05 }, // GPIO5_IO03 SD1_CLK
        { IMX_MAKE_PIN_1(5,  4), 0x408, 0x00000014, 0x198, 0x05, 0x05 }, // GPIO5_IO04 SD1_CMD
        { IMX_MAKE_PIN_1(5,  5), 0x40C, 0x00000014, 0x19C, 0x05, 0x05 }, // GPIO5_IO05 SD1_DATA0
        { IMX_MAKE_PIN_1(5,  6), 0x410, 0x00000014, 0x1A0, 0x05, 0x05 }, // GPIO5_IO06 SD1_DATA1
        { IMX_MAKE_PIN_1(5,  7), 0x414, 0x00000014, 0x1A4, 0x05, 0x05 }, // GPIO5_IO07 SD1_DATA2
        { IMX_MAKE_PIN_1(5,  8), 0x418, 0x00000014, 0x1A8, 0x05, 0x05 }, // GPIO5_IO08 SD1_DATA3
        { IMX_MAKE_PIN_1(5,  9), 0x41C, 0x00000014, 0x1AC, 0x05, 0x05 }, // GPIO5_IO09 SD2_CD_B
        { IMX_MAKE_PIN_1(5, 10), 0x420, 0x00000014, 0x1B0, 0x05, 0x05 }, // GPIO5_IO10 SD2_WP
        { IMX_MAKE_PIN_1(5, 11), 0x424, 0x00000014, 0x1B4, 0x05, 0x05 }, // GPIO5_IO11 SD2_RESET_B
        { IMX_MAKE_PIN_1(5, 12), 0x428, 0x00000014, 0x1B8, 0x05, 0x05 }, // GPIO5_IO12 SD2_CLK
        { IMX_MAKE_PIN_1(5, 13), 0x42C, 0x00000014, 0x1BC, 0x05, 0x05 }, // GPIO5_IO13 SD2_CMD
        { IMX_MAKE_PIN_1(5, 14), 0x430, 0x00000014, 0x1C0, 0x05, 0x05 }, // GPIO5_IO14 SD2_DATA0
        { IMX_MAKE_PIN_1(5, 15), 0x434, 0x00000014, 0x1C4, 0x05, 0x05 }, // GPIO5_IO15 SD2_DATA1
        { IMX_MAKE_PIN_1(5, 16), 0x438, 0x00000014, 0x1C8, 0x05, 0x05 }, // GPIO5_IO16 SD2_DATA2
        { IMX_MAKE_PIN_1(5, 17), 0x43C, 0x00000014, 0x1CC, 0x05, 0x05 }, // GPIO5_IO17 SD2_DATA3
        { IMX_MAKE_PIN_1(6,  0), 0x440, 0x00000014, 0x1D0, 0x05, 0x05 }, // GPIO6_IO00 SD3_CLK
        { IMX_MAKE_PIN_1(6,  1), 0x444, 0x00000014, 0x1D4, 0x05, 0x05 }, // GPIO6_IO01 SD3_CMD
        { IMX_MAKE_PIN_1(6,  2), 0x448, 0x00000014, 0x1D8, 0x05, 0x05 }, // GPIO6_IO02 SD3_DATA0
        { IMX_MAKE_PIN_1(6,  3), 0x44C, 0x00000014, 0x1DC, 0x05, 0x05 }, // GPIO6_IO03 SD3_DATA1
        { IMX_MAKE_PIN_1(6,  4), 0x450, 0x00000014, 0x1E0, 0x05, 0x05 }, // GPIO6_IO04 SD3_DATA2
        { IMX_MAKE_PIN_1(6,  5), 0x454, 0x00000014, 0x1E4, 0x05, 0x05 }, // GPIO6_IO05 SD3_DATA3
        { IMX_MAKE_PIN_1(6,  6), 0x458, 0x00000014, 0x1E8, 0x05, 0x05 }, // GPIO6_IO06 SD3_DATA4
        { IMX_MAKE_PIN_1(6,  7), 0x45C, 0x00000014, 0x1EC, 0x05, 0x05 }, // GPIO6_IO07 SD3_DATA5
        { IMX_MAKE_PIN_1(6,  8), 0x460, 0x00000014, 0x1F0, 0x05, 0x05 }, // GPIO6_IO08 SD3_DATA6
        { IMX_MAKE_PIN_1(6,  9), 0x464, 0x00000014, 0x1F4, 0x05, 0x05 }, // GPIO6_IO09 SD3_DATA7
        { IMX_MAKE_PIN_1(6, 10), 0x468, 0x00000014, 0x1F8, 0x05, 0x05 }, // GPIO6_IO10 SD3_STROBE
        { IMX_MAKE_PIN_1(6, 11), 0x46C, 0x00000014, 0x1FC, 0x05, 0x05 }, // GPIO6_IO11 SD3_RESET_B
        { IMX_MAKE_PIN_1(6, 12), 0x470, 0x00000014, 0x200, 0x05, 0x05 }, // GPIO6_IO12 SAI1_RX_DATA
        { IMX_MAKE_PIN_1(6, 13), 0x474, 0x00000014, 0x204, 0x05, 0x05 }, // GPIO6_IO13 SAI1_TX_BCLK
        { IMX_MAKE_PIN_1(6, 14), 0x478, 0x00000014, 0x208, 0x05, 0x05 }, // GPIO6_IO14 SAI1_TX_SYNC
        { IMX_MAKE_PIN_1(6, 15), 0x47C, 0x00000014, 0x20C, 0x05, 0x05 }, // GPIO6_IO15 SAI1_TX_DATA
        { IMX_MAKE_PIN_1(6, 16), 0x480, 0x00000014, 0x210, 0x05, 0x05 }, // GPIO6_IO16 SAI1_RX_SYNC
        { IMX_MAKE_PIN_1(6, 17), 0x484, 0x00000014, 0x214, 0x05, 0x05 }, // GPIO6_IO17 SAI1_RX_BCLK
        { IMX_MAKE_PIN_1(6, 18), 0x488, 0x00000014, 0x218, 0x05, 0x05 }, // GPIO6_IO18 SAI1_MCLK
        { IMX_MAKE_PIN_1(6, 19), 0x48C, 0x00000014, 0x21C, 0x05, 0x05 }, // GPIO6_IO19 SAI2_TX_SYNC
        { IMX_MAKE_PIN_1(6, 20), 0x490, 0x00000014, 0x220, 0x05, 0x05 }, // GPIO6_IO20 SAI2_TX_BCLK
        { IMX_MAKE_PIN_1(6, 21), 0x494, 0x00000014, 0x224, 0x05, 0x05 }, // GPIO6_IO21 SAI2_RX_DATA
        { IMX_MAKE_PIN_1(6, 22), 0x498, 0x00000014, 0x228, 0x05, 0x05 }, // GPIO6_IO22 SAI2_TX_DATA
        { IMX_MAKE_PIN_1(7,  0), 0x49C, 0x00000014, 0x22C, 0x05, 0x05 }, // GPIO7_IO00 ENET1_RGMII_RD0
        { IMX_MAKE_PIN_1(7,  1), 0x4A0, 0x00000014, 0x230, 0x05, 0x05 }, // GPIO7_IO01 ENET1_RGMII_RD1
        { IMX_MAKE_PIN_1(7,  2), 0x4A4, 0x00000014, 0x234, 0x05, 0x05 }, // GPIO7_IO02 ENET1_RGMII_RD2
        { IMX_MAKE_PIN_1(7,  3), 0x4A8, 0x00000014, 0x238, 0x05, 0x05 }, // GPIO7_IO03 ENET1_RGMII_RD3
        { IMX_MAKE_PIN_1(7,  4), 0x4AC, 0x00000014, 0x23C, 0x05, 0x05 }, // GPIO7_IO04 ENET1_RGMII_RX_CTL
        { IMX_MAKE_PIN_1(7,  5), 0x4B0, 0x00000014, 0x240, 0x05, 0x05 }, // GPIO7_IO05 ENET1_RGMII_RXC
        { IMX_MAKE_PIN_1(7,  6), 0x4B4, 0x00000014, 0x244, 0x05, 0x05 }, // GPIO7_IO06 ENET1_RGMII_TD0
        { IMX_MAKE_PIN_1(7,  7), 0x4B8, 0x00000014, 0x248, 0x05, 0x05 }, // GPIO7_IO07 ENET1_RGMII_TD1
        { IMX_MAKE_PIN_1(7,  8), 0x4BC, 0x00000014, 0x24C, 0x05, 0x05 }, // GPIO7_IO08 ENET1_RGMII_TD2
        { IMX_MAKE_PIN_1(7,  9), 0x4C0, 0x00000014, 0x250, 0x05, 0x05 }, // GPIO7_IO09 ENET1_RGMII_TD3
        { IMX_MAKE_PIN_1(7, 10), 0x4C4, 0x00000014, 0x254, 0x05, 0x05 }, // GPIO7_IO10 ENET1_RGMII_TX_CTL
        { IMX_MAKE_PIN_1(7, 11), 0x4C8, 0x00000014, 0x258, 0x05, 0x05 }, // GPIO7_IO11 ENET1_RGMII_TXC
        { IMX_MAKE_PIN_1(7, 12), 0x4CC, 0x00000014, 0x25C, 0x05, 0x05 }, // GPIO7_IO12 ENET1_TX_CLK
        { IMX_MAKE_PIN_1(7, 13), 0x4D0, 0x00000014, 0x260, 0x05, 0x05 }, // GPIO7_IO13 ENET1_RX_CLK
        { IMX_MAKE_PIN_1(7, 14), 0x4D4, 0x00000014, 0x264, 0x05, 0x05 }, // GPIO7_IO14 ENET1_CRS
        { IMX_MAKE_PIN_1(7, 15), 0x4D8, 0x00000014, 0x268, 0x05, 0x05 }, // GPIO7_IO15 ENET1_COL
