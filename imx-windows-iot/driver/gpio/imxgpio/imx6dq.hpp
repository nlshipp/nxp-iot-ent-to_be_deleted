...
namespace {
	...
	const IMX_PIN_DATA Imx6DQGpioPinDataSparseMap[] = {
        ...
        //--------------------------------------------------
        { IMX_MAKE_PIN_1(1,  0), 0x5F0, 0x0001B0B0, 0x220, 0x05, 0x05 }, // GPIO1_IO00 GPIO_0
        { IMX_MAKE_PIN_1(1,  1), 0x5F4, 0x0001B0B0, 0x224, 0x05, 0x05 }, // GPIO1_IO01 GPIO_1
        { IMX_MAKE_PIN_1(1,  2), 0x604, 0x0001B0B0, 0x234, 0x05, 0x05 }, // GPIO1_IO02 GPIO_2
        { IMX_MAKE_PIN_1(1,  3), 0x5FC, 0x0001B0B0, 0x22C, 0x05, 0x05 }, // GPIO1_IO03 GPIO_3
        { IMX_MAKE_PIN_1(1,  4), 0x608, 0x0001B0B0, 0x238, 0x05, 0x05 }, // GPIO1_IO04 GPIO_4
        { IMX_MAKE_PIN_1(1,  5), 0x60C, 0x0001B0B0, 0x23C, 0x05, 0x05 }, // GPIO1_IO05 GPIO_5
        { IMX_MAKE_PIN_1(1,  6), 0x600, 0x0001B0B0, 0x230, 0x05, 0x05 }, // GPIO1_IO06 GPIO_6
        { IMX_MAKE_PIN_1(1,  7), 0x610, 0x0001B0B0, 0x240, 0x05, 0x05 }, // GPIO1_IO07 GPIO_7
        { IMX_MAKE_PIN_1(1,  8), 0x614, 0x0001B0B0, 0x244, 0x05, 0x05 }, // GPIO1_IO08 GPIO_8
        { IMX_MAKE_PIN_1(1,  9), 0x5F8, 0x0001B0B0, 0x228, 0x05, 0x05 }, // GPIO1_IO09 GPIO_9
        { IMX_MAKE_PIN_1(1, 10), 0x73C, 0x0001B0B0, 0x354, 0x05, 0x05 }, // GPIO1_IO10 SD2_CLK
        { IMX_MAKE_PIN_1(1, 11), 0x740, 0x0001B0B0, 0x358, 0x05, 0x05 }, // GPIO1_IO11 SD2_CMD
        { IMX_MAKE_PIN_1(1, 12), 0x744, 0x0001B0B0, 0x35C, 0x05, 0x05 }, // GPIO1_IO12 SD2_DAT3
        { IMX_MAKE_PIN_1(1, 13), 0x364, 0x0001B0B0,  0x50, 0x05, 0x05 }, // GPIO1_IO13 SD2_DAT2
        { IMX_MAKE_PIN_1(1, 14), 0x360, 0x0001B0B0,  0x4C, 0x05, 0x05 }, // GPIO1_IO14 SD2_DAT1
        { IMX_MAKE_PIN_1(1, 15), 0x368, 0x0001B0B0,  0x54, 0x05, 0x05 }, // GPIO1_IO15 SD2_DAT0
        { IMX_MAKE_PIN_1(1, 16), 0x728, 0x0001B0B0, 0x340, 0x05, 0x05 }, // GPIO1_IO16 SD1_DAT0
        { IMX_MAKE_PIN_1(1, 17), 0x724, 0x0001B0B0, 0x33C, 0x05, 0x05 }, // GPIO1_IO17 SD1_DAT1
        { IMX_MAKE_PIN_1(1, 18), 0x730, 0x0001B0B0, 0x348, 0x05, 0x05 }, // GPIO1_IO18 SD1_CMD
        { IMX_MAKE_PIN_1(1, 19), 0x734, 0x0001B0B0, 0x34C, 0x05, 0x05 }, // GPIO1_IO19 SD1_DAT2
        { IMX_MAKE_PIN_1(1, 20), 0x738, 0x0001B0B0, 0x350, 0x05, 0x05 }, // GPIO1_IO20 SD1_CLK
        { IMX_MAKE_PIN_1(1, 21), 0x72C, 0x0001B0B0, 0x344, 0x05, 0x05 }, // GPIO1_IO21 SD1_DAT3
        { IMX_MAKE_PIN_1(1, 22), 0x4E4, 0x0001B0B0, 0x1D0, 0x05, 0x05 }, // GPIO1_IO22 ENET_MDIO
        { IMX_MAKE_PIN_1(1, 23), 0x4E8, 0x0001B0B0, 0x1D4, 0x05, 0x05 }, // GPIO1_IO23 ENET_REF_CLK
        { IMX_MAKE_PIN_1(1, 24), 0x4EC, 0x0001B0B0, 0x1D8, 0x05, 0x05 }, // GPIO1_IO24 ENET_RX_ER
        { IMX_MAKE_PIN_1(1, 25), 0x4F0, 0x0001B0B0, 0x1DC, 0x05, 0x05 }, // GPIO1_IO25 ENET_CRS_DV
        { IMX_MAKE_PIN_1(1, 26), 0x4F4, 0x0001B0B0, 0x1E0, 0x05, 0x05 }, // GPIO1_IO26 ENET_RXD1
        { IMX_MAKE_PIN_1(1, 27), 0x4F8, 0x0001B0B0, 0x1E4, 0x05, 0x05 }, // GPIO1_IO27 ENET_RXD0
        { IMX_MAKE_PIN_1(1, 28), 0x4FC, 0x0001B0B0, 0x1E8, 0x05, 0x05 }, // GPIO1_IO28 ENET_TX_EN
        { IMX_MAKE_PIN_1(1, 29), 0x500, 0x0001B0B0, 0x1EC, 0x05, 0x05 }, // GPIO1_IO29 ENET_TXD1
        { IMX_MAKE_PIN_1(1, 30), 0x504, 0x0001B0B0, 0x1F0, 0x05, 0x05 }, // GPIO1_IO30 ENET_TXD0
        { IMX_MAKE_PIN_1(1, 31), 0x508, 0x0001B0B0, 0x1F4, 0x05, 0x05 }, // GPIO1_IO31 ENET_MDC
        { IMX_MAKE_PIN_1(2,  0), 0x6E4, 0x0001B0B0, 0x2FC, 0x05, 0x05 }, // GPIO2_IO00 NANDF_D0
        { IMX_MAKE_PIN_1(2,  1), 0x6E8, 0x0001B0B0, 0x300, 0x05, 0x05 }, // GPIO2_IO01 NANDF_D1
        { IMX_MAKE_PIN_1(2,  2), 0x6EC, 0x0001B0B0, 0x304, 0x05, 0x05 }, // GPIO2_IO02 NANDF_D2
        { IMX_MAKE_PIN_1(2,  3), 0x6F0, 0x0001B0B0, 0x308, 0x05, 0x05 }, // GPIO2_IO03 NANDF_D3
        { IMX_MAKE_PIN_1(2,  4), 0x6F4, 0x0001B0B0, 0x30C, 0x05, 0x05 }, // GPIO2_IO04 NANDF_D4
        { IMX_MAKE_PIN_1(2,  5), 0x6F8, 0x0001B0B0, 0x310, 0x05, 0x05 }, // GPIO2_IO05 NANDF_D5
        { IMX_MAKE_PIN_1(2,  6), 0x6FC, 0x0001B0B0, 0x314, 0x05, 0x05 }, // GPIO2_IO06 NANDF_D6
        { IMX_MAKE_PIN_1(2,  7), 0x700, 0x0001B0B0, 0x318, 0x05, 0x05 }, // GPIO2_IO07 NANDF_D7
        { IMX_MAKE_PIN_1(2,  8), 0x704, 0x0001B0B0, 0x31C, 0x05, 0x05 }, // GPIO2_IO08 SD4_DAT0
        { IMX_MAKE_PIN_1(2,  9), 0x708, 0x0001B0B0, 0x320, 0x05, 0x05 }, // GPIO2_IO09 SD4_DAT1
        { IMX_MAKE_PIN_1(2, 10), 0x70C, 0x0001B0B0, 0x324, 0x05, 0x05 }, // GPIO2_IO10 SD4_DAT2
        { IMX_MAKE_PIN_1(2, 11), 0x710, 0x0001B0B0, 0x328, 0x05, 0x05 }, // GPIO2_IO11 SD4_DAT3
        { IMX_MAKE_PIN_1(2, 12), 0x714, 0x0001B0B0, 0x32C, 0x05, 0x05 }, // GPIO2_IO12 SD4_DAT4
        { IMX_MAKE_PIN_1(2, 13), 0x718, 0x0001B0B0, 0x330, 0x05, 0x05 }, // GPIO2_IO13 SD4_DAT5
        { IMX_MAKE_PIN_1(2, 14), 0x71C, 0x0001B0B0, 0x334, 0x05, 0x05 }, // GPIO2_IO14 SD4_DAT6
        { IMX_MAKE_PIN_1(2, 15), 0x720, 0x0001B0B0, 0x338, 0x05, 0x05 }, // GPIO2_IO15 SD4_DAT7
        { IMX_MAKE_PIN_1(2, 16), 0x3F0, 0x0000B0B1,  0xDC, 0x00, 0x05 }, // GPIO2_IO16 EIM_A22
        { IMX_MAKE_PIN_1(2, 17), 0x3F4, 0x0000B0B1,  0xE0, 0x00, 0x05 }, // GPIO2_IO17 EIM_A21
        { IMX_MAKE_PIN_1(2, 18), 0x3F8, 0x0000B0B1,  0xE4, 0x00, 0x05 }, // GPIO2_IO18 EIM_A20
        { IMX_MAKE_PIN_1(2, 19), 0x3FC, 0x0000B0B1,  0xE8, 0x00, 0x05 }, // GPIO2_IO19 EIM_A19
        { IMX_MAKE_PIN_1(2, 20), 0x400, 0x0000B0B1,  0xEC, 0x00, 0x05 }, // GPIO2_IO20 EIM_A18
        { IMX_MAKE_PIN_1(2, 21), 0x404, 0x0000B0B1,  0xF0, 0x00, 0x05 }, // GPIO2_IO21 EIM_A17
        { IMX_MAKE_PIN_1(2, 22), 0x408, 0x0000B0B1,  0xF4, 0x00, 0x05 }, // GPIO2_IO22 EIM_A16
        { IMX_MAKE_PIN_1(2, 23), 0x40C, 0x0000B0B1,  0xF8, 0x00, 0x05 }, // GPIO2_IO23 EIM_CS0
        { IMX_MAKE_PIN_1(2, 24), 0x410, 0x0000B0B1,  0xFC, 0x00, 0x05 }, // GPIO2_IO24 EIM_CS1
        { IMX_MAKE_PIN_1(2, 25), 0x414, 0x0000B0B1, 0x100, 0x00, 0x05 }, // GPIO2_IO25 EIM_OE
        { IMX_MAKE_PIN_1(2, 26), 0x418, 0x0000B0B1, 0x104, 0x00, 0x05 }, // GPIO2_IO26 EIM_RW
        { IMX_MAKE_PIN_1(2, 27), 0x41C, 0x0000B0B1, 0x108, 0x00, 0x05 }, // GPIO2_IO27 EIM_LBA
        { IMX_MAKE_PIN_1(2, 28), 0x420, 0x0000B0B1, 0x10C, 0x00, 0x05 }, // GPIO2_IO28 EIM_EB0
        { IMX_MAKE_PIN_1(2, 29), 0x424, 0x0000B0B1, 0x110, 0x00, 0x05 }, // GPIO2_IO29 EIM_EB1
        { IMX_MAKE_PIN_1(2, 30), 0x3A0, 0x0001B0B0,  0x8C, 0x05, 0x05 }, // GPIO2_IO30 EIM_EB2
        { IMX_MAKE_PIN_1(2, 31), 0x3C4, 0x0001B0B0,  0xB0, 0x05, 0x05 }, // GPIO2_IO31 EIM_EB3
        { IMX_MAKE_PIN_1(3,  0), 0x428, 0x0000B0B1, 0x114, 0x00, 0x05 }, // GPIO3_IO00 EIM_DA0
        { IMX_MAKE_PIN_1(3,  1), 0x42C, 0x0000B0B1, 0x118, 0x00, 0x05 }, // GPIO3_IO01 EIM_DA1
        { IMX_MAKE_PIN_1(3,  2), 0x430, 0x0000B0B1, 0x11C, 0x00, 0x05 }, // GPIO3_IO02 EIM_DA2
        { IMX_MAKE_PIN_1(3,  3), 0x434, 0x0000B0B1, 0x120, 0x00, 0x05 }, // GPIO3_IO03 EIM_DA3
        { IMX_MAKE_PIN_1(3,  4), 0x438, 0x0000B0B1, 0x124, 0x00, 0x05 }, // GPIO3_IO04 EIM_DA4
        { IMX_MAKE_PIN_1(3,  5), 0x43C, 0x0000B0B1, 0x128, 0x00, 0x05 }, // GPIO3_IO05 EIM_DA5
        { IMX_MAKE_PIN_1(3,  6), 0x440, 0x0000B0B1, 0x12C, 0x00, 0x05 }, // GPIO3_IO06 EIM_DA6
        { IMX_MAKE_PIN_1(3,  7), 0x444, 0x0000B0B1, 0x130, 0x00, 0x05 }, // GPIO3_IO07 EIM_DA7
        { IMX_MAKE_PIN_1(3,  8), 0x448, 0x0000B0B1, 0x134, 0x00, 0x05 }, // GPIO3_IO08 EIM_DA8
        { IMX_MAKE_PIN_1(3,  9), 0x44C, 0x0000B0B1, 0x138, 0x00, 0x05 }, // GPIO3_IO09 EIM_DA9
        { IMX_MAKE_PIN_1(3, 10), 0x450, 0x0000B0B1, 0x13C, 0x00, 0x05 }, // GPIO3_IO10 EIM_DA10
        { IMX_MAKE_PIN_1(3, 11), 0x454, 0x0000B0B1, 0x140, 0x00, 0x05 }, // GPIO3_IO11 EIM_DA11
        { IMX_MAKE_PIN_1(3, 12), 0x458, 0x0000B0B1, 0x144, 0x00, 0x05 }, // GPIO3_IO12 EIM_DA12
        { IMX_MAKE_PIN_1(3, 13), 0x45C, 0x0000B0B1, 0x148, 0x00, 0x05 }, // GPIO3_IO13 EIM_DA13
        { IMX_MAKE_PIN_1(3, 14), 0x460, 0x0000B0B1, 0x14C, 0x00, 0x05 }, // GPIO3_IO14 EIM_DA14
        { IMX_MAKE_PIN_1(3, 15), 0x464, 0x0000B0B1, 0x150, 0x00, 0x05 }, // GPIO3_IO15 EIM_DA15
        { IMX_MAKE_PIN_1(3, 16), 0x3A4, 0x0001B0B0,  0x90, 0x05, 0x05 }, // GPIO3_IO16 EIM_D16
        { IMX_MAKE_PIN_1(3, 17), 0x3A8, 0x0001B0B0,  0x94, 0x05, 0x05 }, // GPIO3_IO17 EIM_D17
        { IMX_MAKE_PIN_1(3, 18), 0x3AC, 0x0001B0B0,  0x98, 0x05, 0x05 }, // GPIO3_IO18 EIM_D18
        { IMX_MAKE_PIN_1(3, 19), 0x3B0, 0x0001B0B0,  0x9C, 0x05, 0x05 }, // GPIO3_IO19 EIM_D19
        { IMX_MAKE_PIN_1(3, 20), 0x3B4, 0x0001B0B0,  0xA0, 0x05, 0x05 }, // GPIO3_IO20 EIM_D20
        { IMX_MAKE_PIN_1(3, 21), 0x3B8, 0x0001B0B0,  0xA4, 0x05, 0x05 }, // GPIO3_IO21 EIM_D21
        { IMX_MAKE_PIN_1(3, 22), 0x3BC, 0x0001B0B0,  0xA8, 0x05, 0x05 }, // GPIO3_IO22 EIM_D22
        { IMX_MAKE_PIN_1(3, 23), 0x3C0, 0x0001B0B0,  0xAC, 0x05, 0x05 }, // GPIO3_IO23 EIM_D23
        { IMX_MAKE_PIN_1(3, 24), 0x3C8, 0x0001B0B0,  0xB4, 0x05, 0x05 }, // GPIO3_IO24 EIM_D24
        { IMX_MAKE_PIN_1(3, 25), 0x3CC, 0x0001B0B0,  0xB8, 0x05, 0x05 }, // GPIO3_IO25 EIM_D25
        { IMX_MAKE_PIN_1(3, 26), 0x3D0, 0x0001B0B0,  0xBC, 0x05, 0x05 }, // GPIO3_IO26 EIM_D26
        { IMX_MAKE_PIN_1(3, 27), 0x3D4, 0x0001B0B0,  0xC0, 0x05, 0x05 }, // GPIO3_IO27 EIM_D27
        { IMX_MAKE_PIN_1(3, 28), 0x3D8, 0x0001B0B0,  0xC4, 0x05, 0x05 }, // GPIO3_IO28 EIM_D28
        { IMX_MAKE_PIN_1(3, 29), 0x3DC, 0x0001B0B0,  0xC8, 0x05, 0x05 }, // GPIO3_IO29 EIM_D29
        { IMX_MAKE_PIN_1(3, 30), 0x3E0, 0x0001B0B0,  0xCC, 0x05, 0x05 }, // GPIO3_IO30 EIM_D30
        { IMX_MAKE_PIN_1(3, 31), 0x3E4, 0x0001B0B0,  0xD0, 0x05, 0x05 }, // GPIO3_IO31 EIM_D31
        { IMX_MAKE_PIN_1(4,  5), 0x624, 0x0001B0B0, 0x254, 0x05, 0x05 }, // GPIO4_IO05 GPIO_19
        { IMX_MAKE_PIN_1(4,  6), 0x5C8, 0x0001B0B0, 0x1F8, 0x05, 0x05 }, // GPIO4_IO06 KEY_COL0
        { IMX_MAKE_PIN_1(4,  7), 0x5CC, 0x0001B0B0, 0x1FC, 0x05, 0x05 }, // GPIO4_IO07 KEY_ROW0
        { IMX_MAKE_PIN_1(4,  8), 0x5D0, 0x0001B0B0, 0x200, 0x05, 0x05 }, // GPIO4_IO08 KEY_COL1
        { IMX_MAKE_PIN_1(4,  9), 0x5D4, 0x0001B0B0, 0x204, 0x05, 0x05 }, // GPIO4_IO09 KEY_ROW1
        { IMX_MAKE_PIN_1(4, 10), 0x5D8, 0x0001B0B0, 0x208, 0x05, 0x05 }, // GPIO4_IO10 KEY_COL2
        { IMX_MAKE_PIN_1(4, 11), 0x5DC, 0x0001B0B0, 0x20C, 0x05, 0x05 }, // GPIO4_IO11 KEY_ROW2
        { IMX_MAKE_PIN_1(4, 12), 0x5E0, 0x0001B0B0, 0x210, 0x05, 0x05 }, // GPIO4_IO12 KEY_COL3
        { IMX_MAKE_PIN_1(4, 13), 0x5E4, 0x0001B0B0, 0x214, 0x05, 0x05 }, // GPIO4_IO13 KEY_ROW3
        { IMX_MAKE_PIN_1(4, 14), 0x5E8, 0x0001B0B0, 0x218, 0x05, 0x05 }, // GPIO4_IO14 KEY_COL4
        { IMX_MAKE_PIN_1(4, 15), 0x5EC, 0x0001B0B0, 0x21C, 0x05, 0x05 }, // GPIO4_IO15 KEY_ROW4
        { IMX_MAKE_PIN_1(4, 16), 0x470, 0x0001B0B0, 0x15C, 0x05, 0x05 }, // GPIO4_IO16 DI0_DISP_CLK
        { IMX_MAKE_PIN_1(4, 17), 0x474, 0x0001B0B0, 0x160, 0x05, 0x05 }, // GPIO4_IO17 DI0_PIN15
        { IMX_MAKE_PIN_1(4, 18), 0x478, 0x0001B0B0, 0x164, 0x05, 0x05 }, // GPIO4_IO18 DI0_PIN2
        { IMX_MAKE_PIN_1(4, 19), 0x47C, 0x0001B0B0, 0x168, 0x05, 0x05 }, // GPIO4_IO19 DI0_PIN3
        { IMX_MAKE_PIN_1(4, 20), 0x480, 0x0001B0B0, 0x16C, 0x05, 0x05 }, // GPIO4_IO20 DI0_PIN4
        { IMX_MAKE_PIN_1(4, 21), 0x484, 0x0001B0B0, 0x170, 0x05, 0x05 }, // GPIO4_IO21 DISP0_DAT0
        { IMX_MAKE_PIN_1(4, 22), 0x488, 0x0001B0B0, 0x174, 0x05, 0x05 }, // GPIO4_IO22 DISP0_DAT1
        { IMX_MAKE_PIN_1(4, 23), 0x48C, 0x0001B0B0, 0x178, 0x05, 0x05 }, // GPIO4_IO23 DISP0_DAT2
        { IMX_MAKE_PIN_1(4, 24), 0x490, 0x0001B0B0, 0x17C, 0x05, 0x05 }, // GPIO4_IO24 DISP0_DAT3
        { IMX_MAKE_PIN_1(4, 25), 0x494, 0x0001B0B0, 0x180, 0x05, 0x05 }, // GPIO4_IO25 DISP0_DAT4
        { IMX_MAKE_PIN_1(4, 26), 0x498, 0x0001B0B0, 0x184, 0x05, 0x05 }, // GPIO4_IO26 DISP0_DAT5
        { IMX_MAKE_PIN_1(4, 27), 0x49C, 0x0001B0B0, 0x188, 0x05, 0x05 }, // GPIO4_IO27 DISP0_DAT6
        { IMX_MAKE_PIN_1(4, 28), 0x4A0, 0x0001B0B0, 0x18C, 0x05, 0x05 }, // GPIO4_IO28 DISP0_DAT7
        { IMX_MAKE_PIN_1(4, 29), 0x4A4, 0x0001B0B0, 0x190, 0x05, 0x05 }, // GPIO4_IO29 DISP0_DAT8
        { IMX_MAKE_PIN_1(4, 30), 0x4A8, 0x0001B0B0, 0x194, 0x05, 0x05 }, // GPIO4_IO30 DISP0_DAT9
        { IMX_MAKE_PIN_1(4, 31), 0x4AC, 0x0001B0B0, 0x198, 0x05, 0x05 }, // GPIO4_IO31 DISP0_DAT10
        { IMX_MAKE_PIN_1(5,  0), 0x468, 0x0000B060, 0x154, 0x00, 0x05 }, // GPIO5_IO00 EIM_WAIT
        { IMX_MAKE_PIN_1(5,  2), 0x39C, 0x0000B0B1,  0x88, 0x00, 0x05 }, // GPIO5_IO02 EIM_A25
        { IMX_MAKE_PIN_1(5,  4), 0x3E8, 0x0000B0B1,  0xD4, 0x00, 0x05 }, // GPIO5_IO04 EIM_A24
        { IMX_MAKE_PIN_1(5,  5), 0x4B0, 0x0001B0B0, 0x19C, 0x05, 0x05 }, // GPIO5_IO05 DISP0_DAT11
        { IMX_MAKE_PIN_1(5,  6), 0x4B4, 0x0001B0B0, 0x1A0, 0x05, 0x05 }, // GPIO5_IO06 DISP0_DAT12
        { IMX_MAKE_PIN_1(5,  7), 0x4B8, 0x0001B0B0, 0x1A4, 0x05, 0x05 }, // GPIO5_IO07 DISP0_DAT13
        { IMX_MAKE_PIN_1(5,  8), 0x4BC, 0x0001B0B0, 0x1A8, 0x05, 0x05 }, // GPIO5_IO08 DISP0_DAT14
        { IMX_MAKE_PIN_1(5,  9), 0x4C0, 0x0001B0B0, 0x1AC, 0x05, 0x05 }, // GPIO5_IO09 DISP0_DAT15
        { IMX_MAKE_PIN_1(5, 10), 0x4C4, 0x0001B0B0, 0x1B0, 0x05, 0x05 }, // GPIO5_IO10 DISP0_DAT16
        { IMX_MAKE_PIN_1(5, 11), 0x4C8, 0x0001B0B0, 0x1B4, 0x05, 0x05 }, // GPIO5_IO11 DISP0_DAT17
        { IMX_MAKE_PIN_1(5, 12), 0x4CC, 0x0001B0B0, 0x1B8, 0x05, 0x05 }, // GPIO5_IO12 DISP0_DAT18
        { IMX_MAKE_PIN_1(5, 13), 0x4D0, 0x0001B0B0, 0x1BC, 0x05, 0x05 }, // GPIO5_IO13 DISP0_DAT19
        { IMX_MAKE_PIN_1(5, 14), 0x4D4, 0x0001B0B0, 0x1C0, 0x05, 0x05 }, // GPIO5_IO14 DISP0_DAT20
        { IMX_MAKE_PIN_1(5, 15), 0x4D8, 0x0001B0B0, 0x1C4, 0x05, 0x05 }, // GPIO5_IO15 DISP0_DAT21
        { IMX_MAKE_PIN_1(5, 16), 0x4DC, 0x0001B0B0, 0x1C8, 0x05, 0x05 }, // GPIO5_IO16 DISP0_DAT22
        { IMX_MAKE_PIN_1(5, 17), 0x4E0, 0x0001B0B0, 0x1CC, 0x05, 0x05 }, // GPIO5_IO17 DISP0_DAT23
        { IMX_MAKE_PIN_1(5, 18), 0x628, 0x0001B0B0, 0x258, 0x05, 0x05 }, // GPIO5_IO18 CSI0_PIXCLK
        { IMX_MAKE_PIN_1(5, 19), 0x62C, 0x0001B0B0, 0x25C, 0x05, 0x05 }, // GPIO5_IO19 CSI0_MCLK
        { IMX_MAKE_PIN_1(5, 20), 0x630, 0x0001B0B0, 0x260, 0x05, 0x05 }, // GPIO5_IO20 CSI0_DATA_EN
        { IMX_MAKE_PIN_1(5, 21), 0x634, 0x0001B0B0, 0x264, 0x05, 0x05 }, // GPIO5_IO21 CSI0_VSYNC
        { IMX_MAKE_PIN_1(5, 22), 0x638, 0x0001B0B0, 0x268, 0x05, 0x05 }, // GPIO5_IO22 CSI0_DAT4
        { IMX_MAKE_PIN_1(5, 23), 0x63C, 0x0001B0B0, 0x26C, 0x05, 0x05 }, // GPIO5_IO23 CSI0_DAT5
        { IMX_MAKE_PIN_1(5, 24), 0x640, 0x0001B0B0, 0x270, 0x05, 0x05 }, // GPIO5_IO24 CSI0_DAT6
        { IMX_MAKE_PIN_1(5, 25), 0x644, 0x0001B0B0, 0x274, 0x05, 0x05 }, // GPIO5_IO25 CSI0_DAT7
        { IMX_MAKE_PIN_1(5, 26), 0x648, 0x0001B0B0, 0x278, 0x05, 0x05 }, // GPIO5_IO26 CSI0_DAT8
        { IMX_MAKE_PIN_1(5, 27), 0x64C, 0x0001B0B0, 0x27C, 0x05, 0x05 }, // GPIO5_IO27 CSI0_DAT9
        { IMX_MAKE_PIN_1(5, 28), 0x650, 0x0001B0B0, 0x280, 0x05, 0x05 }, // GPIO5_IO28 CSI0_DAT10
        { IMX_MAKE_PIN_1(5, 29), 0x654, 0x0001B0B0, 0x284, 0x05, 0x05 }, // GPIO5_IO29 CSI0_DAT11
        { IMX_MAKE_PIN_1(5, 30), 0x658, 0x0001B0B0, 0x288, 0x05, 0x05 }, // GPIO5_IO30 CSI0_DAT12
        { IMX_MAKE_PIN_1(5, 31), 0x65C, 0x0001B0B0, 0x28C, 0x05, 0x05 }, // GPIO5_IO31 CSI0_DAT13
        { IMX_MAKE_PIN_1(6,  0), 0x660, 0x0001B0B0, 0x290, 0x05, 0x05 }, // GPIO6_IO00 CSI0_DAT14
        { IMX_MAKE_PIN_1(6,  1), 0x664, 0x0001B0B0, 0x294, 0x05, 0x05 }, // GPIO6_IO01 CSI0_DAT15
        { IMX_MAKE_PIN_1(6,  2), 0x668, 0x0001B0B0, 0x298, 0x05, 0x05 }, // GPIO6_IO02 CSI0_DAT16
        { IMX_MAKE_PIN_1(6,  3), 0x66C, 0x0001B0B0, 0x29C, 0x05, 0x05 }, // GPIO6_IO03 CSI0_DAT17
        { IMX_MAKE_PIN_1(6,  4), 0x670, 0x0001B0B0, 0x2A0, 0x05, 0x05 }, // GPIO6_IO04 CSI0_DAT18
        { IMX_MAKE_PIN_1(6,  5), 0x674, 0x0001B0B0, 0x2A4, 0x05, 0x05 }, // GPIO6_IO05 CSI0_DAT19
        { IMX_MAKE_PIN_1(6,  6), 0x3EC, 0x0000B0B1,  0xD8, 0x00, 0x05 }, // GPIO6_IO06 EIM_A23
        { IMX_MAKE_PIN_1(6,  7), 0x6BC, 0x0001B0B0, 0x2D4, 0x05, 0x05 }, // GPIO6_IO07 NANDF_CLE
        { IMX_MAKE_PIN_1(6,  8), 0x6C0, 0x0001B0B0, 0x2D8, 0x05, 0x05 }, // GPIO6_IO08 NANDF_ALE
        { IMX_MAKE_PIN_1(6,  9), 0x6C4, 0x0001B0B0, 0x2DC, 0x05, 0x05 }, // GPIO6_IO09 NANDF_WP_B
        { IMX_MAKE_PIN_1(6, 10), 0x6C8, 0x0001B0B0, 0x2E0, 0x05, 0x05 }, // GPIO6_IO10 NANDF_RB0
        { IMX_MAKE_PIN_1(6, 11), 0x6CC, 0x0001B0B0, 0x2E4, 0x05, 0x05 }, // GPIO6_IO11 NANDF_CS0
        { IMX_MAKE_PIN_1(6, 14), 0x6D0, 0x0001B0B0, 0x2E8, 0x05, 0x05 }, // GPIO6_IO14 NANDF_CS1
        { IMX_MAKE_PIN_1(6, 15), 0x6D4, 0x0001B0B0, 0x2EC, 0x05, 0x05 }, // GPIO6_IO15 NANDF_CS2
        { IMX_MAKE_PIN_1(6, 16), 0x6D8, 0x0001B0B0, 0x2F0, 0x05, 0x05 }, // GPIO6_IO16 NANDF_CS3
        { IMX_MAKE_PIN_1(6, 17), 0x690, 0x0001B0B0, 0x2A8, 0x05, 0x05 }, // GPIO6_IO17 SD3_DAT7
        { IMX_MAKE_PIN_1(6, 18), 0x694, 0x0001B0B0, 0x2AC, 0x05, 0x05 }, // GPIO6_IO18 SD3_DAT6
        { IMX_MAKE_PIN_1(6, 19), 0x36C, 0x00013030,  0x58, 0x05, 0x05 }, // GPIO6_IO19 RGMII_TXC
        { IMX_MAKE_PIN_1(6, 20), 0x370, 0x0001B030,  0x5C, 0x05, 0x05 }, // GPIO6_IO20 RGMII_TD0
        { IMX_MAKE_PIN_1(6, 21), 0x374, 0x0001B030,  0x60, 0x05, 0x05 }, // GPIO6_IO21 RGMII_TD1
        { IMX_MAKE_PIN_1(6, 22), 0x378, 0x0001B030,  0x64, 0x05, 0x05 }, // GPIO6_IO22 RGMII_TD2
        { IMX_MAKE_PIN_1(6, 23), 0x37C, 0x0001B030,  0x68, 0x05, 0x05 }, // GPIO6_IO23 RGMII_TD3
        { IMX_MAKE_PIN_1(6, 24), 0x380, 0x00013030,  0x6C, 0x05, 0x05 }, // GPIO6_IO24 RGMII_RX_CTL
        { IMX_MAKE_PIN_1(6, 25), 0x384, 0x0001B030,  0x70, 0x05, 0x05 }, // GPIO6_IO25 RGMII_RD0
        { IMX_MAKE_PIN_1(6, 26), 0x388, 0x00013030,  0x74, 0x05, 0x05 }, // GPIO6_IO26 RGMII_TX_CTL
        { IMX_MAKE_PIN_1(6, 27), 0x38C, 0x0001B030,  0x78, 0x05, 0x05 }, // GPIO6_IO27 RGMII_RD1
        { IMX_MAKE_PIN_1(6, 28), 0x390, 0x0001B030,  0x7C, 0x05, 0x05 }, // GPIO6_IO28 RGMII_RD2
        { IMX_MAKE_PIN_1(6, 29), 0x394, 0x0001B030,  0x80, 0x05, 0x05 }, // GPIO6_IO29 RGMII_RD3
        { IMX_MAKE_PIN_1(6, 30), 0x398, 0x00013030,  0x84, 0x05, 0x05 }, // GPIO6_IO30 RGMII_RXC
        { IMX_MAKE_PIN_1(6, 31), 0x46C, 0x0000B0B1, 0x158, 0x00, 0x05 }, // GPIO6_IO31 EIM_BCLK
        { IMX_MAKE_PIN_1(7,  0), 0x698, 0x0001B0B0, 0x2B0, 0x05, 0x05 }, // GPIO7_IO00 SD3_DAT5
        { IMX_MAKE_PIN_1(7,  1), 0x69C, 0x0001B0B0, 0x2B4, 0x05, 0x05 }, // GPIO7_IO01 SD3_DAT4
        { IMX_MAKE_PIN_1(7,  2), 0x6A0, 0x0001B0B0, 0x2B8, 0x05, 0x05 }, // GPIO7_IO02 SD3_CMD
        { IMX_MAKE_PIN_1(7,  3), 0x6A4, 0x0001B0B0, 0x2BC, 0x05, 0x05 }, // GPIO7_IO03 SD3_CLK
        { IMX_MAKE_PIN_1(7,  4), 0x6A8, 0x0001B0B0, 0x2C0, 0x05, 0x05 }, // GPIO7_IO04 SD3_DAT0
        { IMX_MAKE_PIN_1(7,  5), 0x6AC, 0x0001B0B0, 0x2C4, 0x05, 0x05 }, // GPIO7_IO05 SD3_DAT1
        { IMX_MAKE_PIN_1(7,  6), 0x6B0, 0x0001B0B0, 0x2C8, 0x05, 0x05 }, // GPIO7_IO06 SD3_DAT2
        { IMX_MAKE_PIN_1(7,  7), 0x6B4, 0x0001B0B0, 0x2CC, 0x05, 0x05 }, // GPIO7_IO07 SD3_DAT3
        { IMX_MAKE_PIN_1(7,  8), 0x6B8, 0x0001B0B0, 0x2D0, 0x05, 0x05 }, // GPIO7_IO08 SD3_RST
        { IMX_MAKE_PIN_1(7,  9), 0x6DC, 0x0001B0B0, 0x2F4, 0x05, 0x05 }, // GPIO7_IO09 SD4_CMD
        { IMX_MAKE_PIN_1(7, 10), 0x6E0, 0x0001B0B0, 0x2F8, 0x05, 0x05 }, // GPIO7_IO10 SD4_CLK
        { IMX_MAKE_PIN_1(7, 11), 0x618, 0x0001B0B0, 0x248, 0x05, 0x05 }, // GPIO7_IO11 GPIO_16
        { IMX_MAKE_PIN_1(7, 12), 0x61C, 0x0001B0B0, 0x24C, 0x05, 0x05 }, // GPIO7_IO12 GPIO_17
        { IMX_MAKE_PIN_1(7, 13), 0x620, 0x0001B0B0, 0x250, 0x05, 0x05 }, // GPIO7_IO13 GPIO_18
    };
