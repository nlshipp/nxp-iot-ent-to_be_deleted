    ...
    *pCounter = 0;
    switch (Oid) {
        ...
        case OID_GEN_STATISTICS:
            ...
            OID_GEN_RCV_ERROR */
            pAdapter->StatisticsAcc.ifInErrors += (ULONG64)ENETRegBase->RMON_R_CRC_ALIGN + ENETRegBase->RMON_R_UNDERSIZE + ENETRegBase->RMON_R_OVERSIZE;
            ...
            OID_GEN_XMIT_ERROR */
            pAdapter->StatisticsAcc.ifOutErrors += (ULONG64)ENETRegBase->IEEE_T_EXCOL + ENETRegBase->IEEE_T_LCOL;
