...
//
// Auto CMD12 Error Status Register uSDHCx_AUTOCMD12_ERR_STATUS fields
//
#define SDHC_AUTOCMD12_ERR_STATUS_EXECUTE_TUNING (1 << 22)
#define SDHC_AUTOCMD12_ERR_STATUS_SMP_CLK_SEL    (1 << 23)
...
// Tuning Control
//
#define SDHC_TUNING_CTRL_START_TAP_DFLT     0
#define SDHC_TUNING_CTRL_START_TAP_MASK     0xFF
#define SDHC_TUNING_CTRL_START_TAP(v)       (((v) << 0) & SDHC_TUNING_CTRL_START_TAP_MASK)
#define SDHC_TUNING_CTRL_STD_TUNING_EN_MASK (0x1 << 24)
#define SDHC_TUNING_CTRL_TUNING_STEP_DFLT   1
#define SDHC_TUNING_CTRL_TUNING_STEP_MASK   (0x7 << 16)
#define SDHC_TUNING_CTRL_TUNING_STEP(v)     (((v) << 16) & SDHC_TUNING_CTRL_TUNING_STEP_MASK)
